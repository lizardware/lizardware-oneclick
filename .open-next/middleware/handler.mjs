...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 28: (a, b, c) => {
      ...
      "use strict";
      let d;
      c.r(b), c.d(b, { default: () => hJ });
      var e = {};
      async function f() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(e), c.d(e, { config: () => hF, default: () => hD });
      let g = null;
      async function h() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let a8 = () => {
        ...
        return false;
      }, a9 = /* @__PURE__ */ new Set(), ba = (a10, b10, c10) => {
        let d10 = a8(), e10 = c10 ?? a10;
        a9.has(e10) || d10 || (a9.add(e10), console.warn(`Clerk - DEPRECATION WARNING: "${a10}" is deprecated and will be removed in the next major release.
${b10}`));
      }, bb = [".lcl.dev", ".lclstage.dev", ".lclclerk.com"], bc = [".accounts.dev", ".accountsstage.dev", ".accounts.lclclerk.com"], bd = [".lcl.dev", ".stg.dev", ".lclstage.dev", ".stgstage.dev", ".dev.lclclerk.com", ".stg.lclclerk.com", ".accounts.lclclerk.com", "accountsstage.dev", "accounts.dev"], be = [".lcl.dev", "lclstage.dev", ".lclclerk.com", ".accounts.lclclerk.com"], bf = [".accountsstage.dev"], bg = "https://api.clerk.com", bh = (a10) => "undefined" != typeof atob && "function" == typeof atob ? atob(a10) : "undefined" != typeof global && global.Buffer ? new global.Buffer(a10, "base64").toString() : a10, bi = "pk_live_";
      function bj(a10) {
      ...
      let bo = { initialDelay: 125, maxDelayBetweenRetries: 0, factor: 2, shouldRetry: (a10, b10) => b10 < 5, retryImmediately: false, jitter: true }, bp = async (a10) => new Promise((b10) => setTimeout(b10, a10)), bq = (a10, b10) => b10 ? a10 * (1 + Math.random()) : a10, br = async (a10, b10 = {}) => {
        let c10 = 0, { shouldRetry: d10, initialDelay: e10, maxDelayBetweenRetries: f10, factor: g10, retryImmediately: h2, jitter: i2, onBeforeRetry: j2 } = { ...bo, ...b10 }, k2 = /* @__PURE__ */ ((a11) => {
          let b11 = 0;
          return async () => {
            await bp((() => {
              let c11 = a11.initialDelay * Math.pow(a11.factor, b11);
              return c11 = bq(c11, a11.jitter), Math.min(a11.maxDelayBetweenRetries || c11, c11);
            })()), b11++;
          };
        ...
        for (; ; ) try {
          ...
          j2 && await j2(c10), h2 && 1 === c10 ? await bp(bq(100, i2)) : await k2();
        }
      };
      function bs(a10) {
        return function(b10) {
      ...
      bs(bt);
      var bv = class a10 extends Error {
...
Clerk Trace ID: ${this.clerkTraceId}`), a11;
      ...
      function bz({ packageName: a10, customMessages: b10 }) {
        let c10 = a10;
      ...
      }, bG = { TokenInvalid: "token-invalid", InvalidSecretKey: "secret-key-invalid", UnexpectedError: "unexpected-error", TokenVerificationFailed: "token-verification-failed" }, bH = class a10 extends Error {
      ...
      let bI = crypto;
      var bJ = fetch.bind(globalThis), bK = { crypto: bI, get fetch() {
        return bJ;
      }, AbortController: globalThis.AbortController, Blob: globalThis.Blob, FormData: globalThis.FormData, Headers: globalThis.Headers, Request: globalThis.Request, Response: globalThis.Response }, bL = { parse: (a10, b10) => function(a11, b11, c10 = {}) {
        if (!b11.codes) {
          b11.codes = {};
        ...
        return e10;
      }(a10, bM, b10) }, bM = { chars: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", bits: 6 }, bN = { RS256: "SHA-256", RS384: "SHA-384", RS512: "SHA-512" }, bO = "RSASSA-PKCS1-v1_5", bP = { RS256: bO, RS384: bO, RS512: bO }, bQ = Object.keys(bN), bR = (a10, b10 = "JWT") => {
        if (void 0 === a10) return;
        let c10 = Array.isArray(b10) ? b10 : [b10];
        if (!c10.includes(a10)) throw new bF({ action: bE.EnsureClerkJWT, reason: bD.TokenInvalid, message: `Invalid JWT type ${JSON.stringify(a10)}. Expected "${c10.join(", ")}".` });
      }, bS = (a10) => {
        if (!bQ.includes(a10)) throw new bF({ action: bE.EnsureClerkJWT, reason: bD.TokenInvalidAlgorithm, message: `Invalid JWT algorithm ${JSON.stringify(a10)}. Supported: ${bQ}.` });
      };
      async function bT(a10, b10) {
        let { header: c10, signature: d10, raw: e10 } = a10, f10 = new TextEncoder().encode([e10.header, e10.payload].join(".")), g10 = function(a11) {
          let b11 = bN[a11], c11 = bP[a11];
          if (!b11 || !c11) throw Error(`Unsupported algorithm ${a11}, expected one of ${bQ.join(",")}.`);
          return { hash: { name: bN[a11] }, name: bP[a11] };
        }(c10.alg);
        try {
          let a11 = await function(a12, b11, c11) {
            if ("object" == typeof a12) return bK.crypto.subtle.importKey("jwk", a12, b11, false, [c11]);
            ...
            return bK.crypto.subtle.importKey(e11, d11, b11, false, [c11]);
          }(b10, g10, "verify");
          return { data: await bK.crypto.subtle.verify(g10.name, a11, d10, f10) };
        } catch (a11) {
          return { errors: [new bF({ reason: bD.TokenInvalidSignature, message: a11?.message })] };
        }
      }
      function bU(a10) {
        let b10 = (a10 || "").toString().split(".");
        if (3 !== b10.length) return { errors: [new bF({ reason: bD.TokenInvalid, message: "Invalid JWT form. A JWT consists of three parts separated by dots." })] };
        let [c10, d10, e10] = b10, f10 = new TextDecoder(), g10 = JSON.parse(f10.decode(bL.parse(c10, { loose: true }))), h2 = JSON.parse(f10.decode(bL.parse(d10, { loose: true })));
        return { data: { header: g10, payload: h2, signature: bL.parse(e10, { loose: true }), raw: { header: c10, payload: d10, signature: e10, text: a10 } } };
      }
      async function bV(a10, b10) {
        let { audience: c10, authorizedParties: d10, clockSkewInMs: e10, key: f10, headerType: g10 } = b10, h2 = e10 || 5e3, { data: i2, errors: j2 } = bU(a10);
        ...
        try {
          ...
          if ("string" != typeof f11) throw new bF({ action: bE.EnsureClerkJWT, reason: bD.TokenVerificationFailed, message: `Subject claim (sub) is required and must be a string. Received ${JSON.stringify(f11)}.` });
          ((a12, b12) => {
            let c11 = [b12].flat().filter((a13) => !!a13), d11 = [a12].flat().filter((a13) => !!a13);
            if (c11.length > 0 && d11.length > 0) if ("string" == typeof a12) {
              if (!c11.includes(a12)) throw new bF({ action: bE.EnsureClerkJWT, reason: bD.TokenVerificationFailed, message: `Invalid JWT audience claim (aud) ${JSON.stringify(a12)}. Is not included in "${JSON.stringify(c11)}".` });
            } else {
              let b13;
              if (b13 = a12, Array.isArray(b13) && b13.length > 0 && b13.every((a13) => "string" == typeof a13) && !a12.some((a13) => c11.includes(a13))) throw new bF({ action: bE.EnsureClerkJWT, reason: bD.TokenVerificationFailed, message: `Invalid JWT audience claim array (aud) ${JSON.stringify(a12)}. Is not included in "${JSON.stringify(c11)}".` });
            }
          })([i3], [c10]);
          if (e11 && d10 && 0 !== d10.length && !d10.includes(e11)) throw new bF({ reason: bD.TokenInvalidAuthorizedParties, message: `Invalid JWT Authorized party claim (azp) ${JSON.stringify(e11)}. Expected "${d10}".` });
          if ("number" != typeof m3) throw new bF({ action: bE.EnsureClerkJWT, reason: bD.TokenVerificationFailed, message: `Invalid JWT expiry date claim (exp) ${JSON.stringify(m3)}. Expected number.` });
          let o2 = new Date(Date.now()), p2 = /* @__PURE__ */ new Date(0);
          if (p2.setUTCSeconds(m3), p2.getTime() <= o2.getTime() - h2) throw new bF({ reason: bD.TokenExpired, message: `JWT is expired. Expiry date: ${p2.toUTCString()}, Current date: ${o2.toUTCString()}.` });
          ((a12, b12) => {
            if (void 0 === a12) return;
            if ("number" != typeof a12) throw new bF({ action: bE.EnsureClerkJWT, reason: bD.TokenVerificationFailed, message: `Invalid JWT not before date claim (nbf) ${JSON.stringify(a12)}. Expected number.` });
            let c11 = new Date(Date.now()), d11 = /* @__PURE__ */ new Date(0);
            if (d11.setUTCSeconds(a12), d11.getTime() > c11.getTime() + b12) throw new bF({ reason: bD.TokenNotActiveYet, message: `JWT cannot be used prior to not before date claim (nbf). Not before date: ${d11.toUTCString()}; Current date: ${c11.toUTCString()};` });
          })(n3, h2), ((a12, b12) => {
            if (void 0 === a12) return;
            if ("number" != typeof a12) throw new bF({ action: bE.EnsureClerkJWT, reason: bD.TokenVerificationFailed, message: `Invalid JWT issued at date claim (iat) ${JSON.stringify(a12)}. Expected number.` });
            let c11 = new Date(Date.now()), d11 = /* @__PURE__ */ new Date(0);
            if (d11.setUTCSeconds(a12), d11.getTime() > c11.getTime() + b12) throw new bF({ reason: bD.TokenIatInTheFuture, message: `JWT issued at date claim (iat) is in the future. Issued at date: ${d11.toUTCString()}; Current date: ${c11.toUTCString()};` });
          })(j3, h2);
        } catch (a11) {
          return { errors: [a11] };
        }
        let { data: m2, errors: n2 } = await bT(i2, f10);
        return n2 ? { errors: [new bF({ action: bE.EnsureClerkJWT, reason: bD.TokenVerificationFailed, message: `Error verifying JWT signature. ${n2[0]}` })] } : m2 ? { data: l2 } : { errors: [new bF({ reason: bD.TokenInvalidSignature, message: "JWT signature is invalid." })] };
      }
      var bW = (a10) => {
        throw TypeError(a10);
      }, bX = (a10, b10, c10) => (b10.has(a10) || bW("Cannot access private method"), c10);
      function bY(a10) {
        return a10 ? `https://${a10.replace(/clerk\.accountsstage\./, "accountsstage.").replace(/clerk\.accounts\.|clerk\./, "accounts.")}` : "";
      }
      let bZ = { strict_mfa: { afterMinutes: 10, level: "multi_factor" }, strict: { afterMinutes: 10, level: "second_factor" }, moderate: { afterMinutes: 60, level: "second_factor" }, lax: { afterMinutes: 1440, level: "second_factor" } }, b$ = /* @__PURE__ */ new Set(["first_factor", "second_factor", "multi_factor"]), b_ = /* @__PURE__ */ new Set(["strict_mfa", "strict", "moderate", "lax"]), b0 = (a10) => a10.replace(/^(org:)*/, "org:"), b1 = (a10, b10) => {
        let { org: c10, user: d10 } = b2(a10), [e10, f10] = b10.split(":"), g10 = f10 || e10;
      ...
      var b3 = c(45), b4 = "https://api.clerk.com", b5 = "@clerk/backend@2.29.0", b6 = "2025-11-10", b7 = { Session: "__session", Refresh: "__refresh", ClientUat: "__client_uat", Handshake: "__clerk_handshake", DevBrowser: "__clerk_db_jwt", RedirectCount: "__clerk_redirect_count", HandshakeNonce: "__clerk_handshake_nonce" }, b8 = { ClerkSynced: "__clerk_synced", SuffixedCookies: "suffixed_cookies", ClerkRedirectUrl: "__clerk_redirect_url", DevBrowser: b7.DevBrowser, Handshake: b7.Handshake, HandshakeHelp: "__clerk_help", LegacyDevBrowser: "__dev_session", HandshakeReason: "__clerk_hs_reason", HandshakeNonce: b7.HandshakeNonce, HandshakeFormat: "format", Session: "__session" }, b9 = { Cookies: b7, Headers: { Accept: "accept", AuthMessage: "x-clerk-auth-message", Authorization: "authorization", AuthReason: "x-clerk-auth-reason", AuthSignature: "x-clerk-auth-signature", AuthStatus: "x-clerk-auth-status", AuthToken: "x-clerk-auth-token", CacheControl: "cache-control", ClerkRedirectTo: "x-clerk-redirect-to", ClerkRequestData: "x-clerk-request-data", ClerkUrl: "x-clerk-clerk-url", CloudFrontForwardedProto: "cloudfront-forwarded-proto", ContentType: "content-type", ContentSecurityPolicy: "content-security-policy", ContentSecurityPolicyReportOnly: "content-security-policy-report-only", EnableDebug: "x-clerk-debug", ForwardedHost: "x-forwarded-host", ForwardedPort: "x-forwarded-port", ForwardedProto: "x-forwarded-proto", Host: "host", Location: "location", Nonce: "x-nonce", Origin: "origin", Referrer: "referer", SecFetchDest: "sec-fetch-dest", SecFetchSite: "sec-fetch-site", UserAgent: "user-agent", ReportingEndpoints: "reporting-endpoints" }, ContentTypes: { Json: "application/json" }, QueryParameters: b8 }, ca = (a10, b10, c10, d10) => {
        if ("" === a10) return cb(b10.toString(), c10?.toString());
        let e10 = new URL(a10), f10 = c10 ? new URL(c10, e10) : void 0, g10 = new URL(b10, e10), h2 = `${e10.hostname}:${e10.port}` != `${g10.hostname}:${g10.port}`;
        return f10 && (h2 && f10.searchParams.delete(b9.QueryParameters.ClerkSynced), g10.searchParams.set("redirect_url", f10.toString())), h2 && d10 && g10.searchParams.set(b9.QueryParameters.DevBrowser, d10), g10.toString();
      }, cb = (a10, b10) => {
        let c10;
      ...
      var ce = { SessionToken: "session_token", ApiKey: "api_key", M2MToken: "m2m_token", OAuthToken: "oauth_token" }, cf = class {
        constructor(a10, b10, c10) {
          this.cookieSuffix = a10, this.clerkRequest = b10, this.originalFrontendApi = "", c10.acceptsToken === ce.M2MToken || c10.acceptsToken === ce.ApiKey ? this.initHeaderValues() : (this.initPublishableKeyValues(c10), this.initHeaderValues(), this.initCookieValues(), this.initHandshakeValues()), Object.assign(this, c10), this.clerkUrl = this.clerkRequest.clerkUrl;
        }
        get sessionToken() {
          return this.sessionTokenInCookie || this.tokenInHeader;
        }
        usesSuffixedCookies() {
          let a10 = this.getSuffixedCookie(b9.Cookies.ClientUat), b10 = this.getCookie(b9.Cookies.ClientUat), c10 = this.getSuffixedCookie(b9.Cookies.Session) || "", d10 = this.getCookie(b9.Cookies.Session) || "";
          if (d10 && !this.tokenHasIssuer(d10)) return false;
          if (d10 && !this.tokenBelongsToInstance(d10)) return true;
          if (!a10 && !c10) return false;
          let { data: e10 } = bU(d10), f10 = e10?.payload.iat || 0, { data: g10 } = bU(c10), h2 = g10?.payload.iat || 0;
        ...
        isKnownClerkReferrer() {
          ...
          try {
            ...
            if (bb.some((a11) => b10.startsWith("accounts.") && b10.endsWith(a11)) || bc.some((a11) => b10.endsWith(a11) && !b10.endsWith(".clerk" + a11))) return true;
            let c10 = bY(this.frontendApi);
            if (c10) {
        ...
        initHeaderValues() {
          this.tokenInHeader = this.parseAuthorizationHeader(this.getHeader(b9.Headers.Authorization)), this.origin = this.getHeader(b9.Headers.Origin), this.host = this.getHeader(b9.Headers.Host), this.forwardedHost = this.getHeader(b9.Headers.ForwardedHost), this.forwardedProto = this.getHeader(b9.Headers.CloudFrontForwardedProto) || this.getHeader(b9.Headers.ForwardedProto), this.referrer = this.getHeader(b9.Headers.Referrer), this.userAgent = this.getHeader(b9.Headers.UserAgent), this.secFetchDest = this.getHeader(b9.Headers.SecFetchDest), this.accept = this.getHeader(b9.Headers.Accept);
        }
        initCookieValues() {
          this.sessionTokenInCookie = this.getSuffixedOrUnSuffixedCookie(b9.Cookies.Session), this.refreshTokenInCookie = this.getSuffixedCookie(b9.Cookies.Refresh), this.clientUat = Number.parseInt(this.getSuffixedOrUnSuffixedCookie(b9.Cookies.ClientUat) || "") || 0;
        }
        initHandshakeValues() {
          this.devBrowserToken = this.getQueryParam(b9.QueryParameters.DevBrowser) || this.getSuffixedOrUnSuffixedCookie(b9.Cookies.DevBrowser), this.handshakeToken = this.getQueryParam(b9.QueryParameters.Handshake) || this.getCookie(b9.Cookies.Handshake), this.handshakeRedirectLoopCounter = Number(this.getCookie(b9.Cookies.RedirectCount)) || 0, this.handshakeNonce = this.getQueryParam(b9.QueryParameters.HandshakeNonce) || this.getCookie(b9.Cookies.HandshakeNonce);
        }
        getQueryParam(a10) {
        ...
        tokenHasIssuer(a10) {
          let { data: b10, errors: c10 } = bU(a10);
      ...
      }, cg = async (a10, b10) => new cf(b10.publishableKey ? await bn(b10.publishableKey, bK.crypto.subtle) : "", a10, b10), ch = RegExp("(?<!:)/{1,}", "g");
      function ci(...a10) {
        return a10.filter((a11) => a11).join("/").replace(ch, "/");
      }
      var cj = class {
        constructor(a10) {
          this.request = a10;
      ...
      }, ck = "/actor_tokens", cl = class extends cj {
        async create(a10) {
          return this.request({ method: "POST", path: ck, bodyParams: a10 });
        }
        async revoke(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(ck, a10, "revoke") });
        }
      }, cm = "/accountless_applications", cn = class extends cj {
        async createAccountlessApplication(a10) {
          let b10 = a10?.requestHeaders ? Object.fromEntries(a10.requestHeaders.entries()) : void 0;
          return this.request({ method: "POST", path: cm, headerParams: b10 });
        }
        async completeAccountlessApplicationOnboarding(a10) {
          let b10 = a10?.requestHeaders ? Object.fromEntries(a10.requestHeaders.entries()) : void 0;
          return this.request({ method: "POST", path: ci(cm, "complete"), headerParams: b10 });
        }
      }, co = "/allowlist_identifiers", cp = class extends cj {
        ...
        async deleteAllowlistIdentifier(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(co, a10) });
        }
      }, cq = "/api_keys", cr = class extends cj {
        async list(a10) {
        ...
        async get(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cq, a10) });
        }
        async update(a10) {
          let { apiKeyId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "PATCH", path: ci(cq, b10), bodyParams: c10 });
        }
        async delete(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cq, a10) });
        }
        async revoke(a10) {
          let { apiKeyId: b10, revocationReason: c10 = null } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: ci(cq, b10, "revoke"), bodyParams: { revocationReason: c10 } });
        }
        async getSecret(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cq, a10, "secret") });
        }
        async verify(a10) {
          return this.request({ method: "POST", path: ci(cq, "verify"), bodyParams: { secret: a10 } });
        }
        async verifySecret(a10) {
          return ba("apiKeys.verifySecret()", "Use `apiKeys.verify()` instead."), this.verify(a10);
        }
      }, cs = class extends cj {
        async changeDomain(a10) {
          return this.request({ method: "POST", path: ci("/beta_features", "change_domain"), bodyParams: a10 });
        }
      }, ct = "/blocklist_identifiers", cu = class extends cj {
        ...
        async deleteBlocklistIdentifier(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(ct, a10) });
        }
      }, cv = "/clients", cw = class extends cj {
        async getClientList(a10 = {}) {
          return this.request({ method: "GET", path: cv, queryParams: { ...a10, paginated: true } });
        }
        async getClient(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cv, a10) });
        }
        verifyClient(a10) {
          return this.request({ method: "POST", path: ci(cv, "verify"), bodyParams: { token: a10 } });
        }
        async getHandshakePayload(a10) {
          return this.request({ method: "GET", path: ci(cv, "handshake_payload"), queryParams: a10 });
        }
      }, cx = "/domains", cy = class extends cj {
        async list() {
          return this.request({ method: "GET", path: cx });
        }
        async add(a10) {
        ...
        async update(a10) {
          ...
          return this.requireId(b10), this.request({ method: "PATCH", path: ci(cx, b10), bodyParams: c10 });
        }
        async delete(a10) {
          return this.deleteDomain(a10);
        }
        async deleteDomain(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cx, a10) });
        }
      }, cz = "/email_addresses", cA = class extends cj {
        async getEmailAddress(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cz, a10) });
        }
        async createEmailAddress(a10) {
          return this.request({ method: "POST", path: cz, bodyParams: a10 });
        }
        async updateEmailAddress(a10, b10 = {}) {
          return this.requireId(a10), this.request({ method: "PATCH", path: ci(cz, a10), bodyParams: b10 });
        }
        async deleteEmailAddress(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cz, a10) });
        }
      }, cB = class extends cj {
        async verify(a10) {
          return this.request({ method: "POST", path: ci("/oauth_applications/access_tokens", "verify"), bodyParams: { access_token: a10 } });
        }
        async verifyAccessToken(a10) {
          return ba("idPOAuthAccessToken.verifyAccessToken()", "Use `idPOAuthAccessToken.verify()` instead."), this.verify(a10);
        }
      }, cC = "/instance", cD = class extends cj {
        async get() {
          return this.request({ method: "GET", path: cC });
        }
        async update(a10) {
          return this.request({ method: "PATCH", path: cC, bodyParams: a10 });
        }
        async updateRestrictions(a10) {
          return this.request({ method: "PATCH", path: ci(cC, "restrictions"), bodyParams: a10 });
        }
        async updateOrganizationSettings(a10) {
          return this.request({ method: "PATCH", path: ci(cC, "organization_settings"), bodyParams: a10 });
        }
      }, cE = "/invitations", cF = class extends cj {
        ...
        async createInvitationBulk(a10) {
          return this.request({ method: "POST", path: ci(cE, "bulk"), bodyParams: a10 });
        }
        async revokeInvitation(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(cE, a10, "revoke") });
        }
      }, cG = "/machines", cH = class extends cj {
        async get(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cG, a10) });
        }
        async list(a10 = {}) {
        ...
        async update(a10) {
          ...
          return this.requireId(b10), this.request({ method: "PATCH", path: ci(cG, b10), bodyParams: c10 });
        }
        async delete(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cG, a10) });
        }
        async getSecretKey(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cG, a10, "secret_key") });
        }
        async rotateSecretKey(a10) {
          let { machineId: b10, previousTokenTtl: c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: ci(cG, b10, "secret_key", "rotate"), bodyParams: { previousTokenTtl: c10 } });
        }
        async createScope(a10, b10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(cG, a10, "scopes"), bodyParams: { toMachineId: b10 } });
        }
        async deleteScope(a10, b10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cG, a10, "scopes", b10) });
        }
      }, cI = "/m2m_tokens", cJ = class extends cj {
        constructor() {
          super(...arguments), ((a10, b10, c10) => b10.has(a10) ? bW("Cannot add the same private member more than once") : b10 instanceof WeakSet ? b10.add(a10) : b10.set(a10, c10))(this, f2);
        }
        async createToken(a10) {
          let { claims: b10 = null, machineSecretKey: c10, secondsUntilExpiration: d10 = null } = a10 || {}, e10 = bX(this, f2, f3).call(this, { method: "POST", path: cI, bodyParams: { secondsUntilExpiration: d10, claims: b10 } }, c10);
          return this.request(e10);
        }
        async revokeToken(a10) {
          let { m2mTokenId: b10, revocationReason: c10 = null, machineSecretKey: d10 } = a10;
          this.requireId(b10);
          let e10 = bX(this, f2, f3).call(this, { method: "POST", path: ci(cI, b10, "revoke"), bodyParams: { revocationReason: c10 } }, d10);
          return this.request(e10);
        }
        async verify(a10) {
          let { token: b10, machineSecretKey: c10 } = a10, d10 = bX(this, f2, f3).call(this, { method: "POST", path: ci(cI, "verify"), bodyParams: { token: b10 } }, c10);
          return this.request(d10);
        }
        async verifyToken(a10) {
          return ba("m2m.verifyToken()", "Use `m2m.verify()` instead."), this.verify(a10);
        }
      };
      f2 = /* @__PURE__ */ new WeakSet(), f3 = function(a10, b10) {
        return b10 ? { ...a10, headerParams: { ...a10.headerParams, Authorization: `Bearer ${b10}` } } : a10;
      };
      var cK = class extends cj {
        async getJwks() {
          return this.request({ method: "GET", path: "/jwks" });
        }
      }, cL = "/jwt_templates", cM = class extends cj {
        async list(a10 = {}) {
          return this.request({ method: "GET", path: cL, queryParams: { ...a10, paginated: true } });
        }
        async get(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cL, a10) });
        }
        async create(a10) {
        ...
        async update(a10) {
          ...
          return this.requireId(b10), this.request({ method: "PATCH", path: ci(cL, b10), bodyParams: c10 });
        }
        async delete(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cL, a10) });
        }
      }, cN = "/organizations", cO = class extends cj {
        ...
        async getOrganization(a10) {
          ...
          return this.requireId(c10), this.request({ method: "GET", path: ci(cN, c10), queryParams: { includeMembersCount: b10 } });
        }
        async updateOrganization(a10, b10) {
          return this.requireId(a10), this.request({ method: "PATCH", path: ci(cN, a10), bodyParams: b10 });
        }
        async updateOrganizationLogo(a10, b10) {
          this.requireId(a10);
          let c10 = new bK.FormData();
          return c10.append("file", b10?.file), b10?.uploaderUserId && c10.append("uploader_user_id", b10?.uploaderUserId), this.request({ method: "PUT", path: ci(cN, a10, "logo"), formData: c10 });
        }
        async deleteOrganizationLogo(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cN, a10, "logo") });
        }
        async updateOrganizationMetadata(a10, b10) {
          return this.requireId(a10), this.request({ method: "PATCH", path: ci(cN, a10, "metadata"), bodyParams: b10 });
        }
        async deleteOrganization(a10) {
          return this.request({ method: "DELETE", path: ci(cN, a10) });
        }
        async getOrganizationMembershipList(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "GET", path: ci(cN, b10, "memberships"), queryParams: c10 });
        }
        ...
        async createOrganizationMembership(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: ci(cN, b10, "memberships"), bodyParams: c10 });
        }
        async updateOrganizationMembership(a10) {
          let { organizationId: b10, userId: c10, ...d10 } = a10;
          return this.requireId(b10), this.request({ method: "PATCH", path: ci(cN, b10, "memberships", c10), bodyParams: d10 });
        }
        async updateOrganizationMembershipMetadata(a10) {
          let { organizationId: b10, userId: c10, ...d10 } = a10;
          return this.request({ method: "PATCH", path: ci(cN, b10, "memberships", c10, "metadata"), bodyParams: d10 });
        }
        async deleteOrganizationMembership(a10) {
          let { organizationId: b10, userId: c10 } = a10;
          return this.requireId(b10), this.request({ method: "DELETE", path: ci(cN, b10, "memberships", c10) });
        }
        async getOrganizationInvitationList(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "GET", path: ci(cN, b10, "invitations"), queryParams: c10 });
        }
        async createOrganizationInvitation(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: ci(cN, b10, "invitations"), bodyParams: c10 });
        }
        async createOrganizationInvitationBulk(a10, b10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(cN, a10, "invitations", "bulk"), bodyParams: b10 });
        }
        async getOrganizationInvitation(a10) {
          let { organizationId: b10, invitationId: c10 } = a10;
          return this.requireId(b10), this.requireId(c10), this.request({ method: "GET", path: ci(cN, b10, "invitations", c10) });
        }
        async revokeOrganizationInvitation(a10) {
          let { organizationId: b10, invitationId: c10, ...d10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: ci(cN, b10, "invitations", c10, "revoke"), bodyParams: d10 });
        }
        async getOrganizationDomainList(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "GET", path: ci(cN, b10, "domains"), queryParams: c10 });
        }
        async createOrganizationDomain(a10) {
          let { organizationId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: ci(cN, b10, "domains"), bodyParams: { ...c10, verified: c10.verified ?? true } });
        }
        async updateOrganizationDomain(a10) {
          let { organizationId: b10, domainId: c10, ...d10 } = a10;
          return this.requireId(b10), this.requireId(c10), this.request({ method: "PATCH", path: ci(cN, b10, "domains", c10), bodyParams: d10 });
        }
        async deleteOrganizationDomain(a10) {
          let { organizationId: b10, domainId: c10 } = a10;
          return this.requireId(b10), this.requireId(c10), this.request({ method: "DELETE", path: ci(cN, b10, "domains", c10) });
        }
      }, cP = "/oauth_applications", cQ = class extends cj {
        async list(a10 = {}) {
          return this.request({ method: "GET", path: cP, queryParams: a10 });
        }
        async get(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cP, a10) });
        }
        async create(a10) {
        ...
        async update(a10) {
          ...
          return this.requireId(b10), this.request({ method: "PATCH", path: ci(cP, b10), bodyParams: c10 });
        }
        async delete(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cP, a10) });
        }
        async rotateSecret(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(cP, a10, "rotate_secret") });
        }
      }, cR = "/phone_numbers", cS = class extends cj {
        async getPhoneNumber(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cR, a10) });
        }
        async createPhoneNumber(a10) {
          return this.request({ method: "POST", path: cR, bodyParams: a10 });
        }
        async updatePhoneNumber(a10, b10 = {}) {
          return this.requireId(a10), this.request({ method: "PATCH", path: ci(cR, a10), bodyParams: b10 });
        }
        async deletePhoneNumber(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cR, a10) });
        }
      }, cT = class extends cj {
        async verify(a10) {
          return this.request({ method: "POST", path: "/proxy_checks", bodyParams: a10 });
        }
      }, cU = "/redirect_urls", cV = class extends cj {
        async getRedirectUrlList() {
          return this.request({ method: "GET", path: cU, queryParams: { paginated: true } });
        }
        async getRedirectUrl(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cU, a10) });
        }
        async createRedirectUrl(a10) {
          return this.request({ method: "POST", path: cU, bodyParams: a10 });
        }
        async deleteRedirectUrl(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cU, a10) });
        }
      }, cW = "/saml_connections", cX = class extends cj {
        async getSamlConnectionList(a10 = {}) {
          return this.request({ method: "GET", path: cW, queryParams: a10 });
        }
        ...
        async getSamlConnection(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cW, a10) });
        }
        async updateSamlConnection(a10, b10 = {}) {
          return this.requireId(a10), this.request({ method: "PATCH", path: ci(cW, a10), bodyParams: b10, options: { deepSnakecaseBodyParamKeys: true } });
        }
        async deleteSamlConnection(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(cW, a10) });
        }
      }, cY = "/sessions", cZ = class extends cj {
        async getSessionList(a10 = {}) {
          return this.request({ method: "GET", path: cY, queryParams: { ...a10, paginated: true } });
        }
        async getSession(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(cY, a10) });
        }
        async createSession(a10) {
          return this.request({ method: "POST", path: cY, bodyParams: a10 });
        }
        async revokeSession(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(cY, a10, "revoke") });
        }
        async verifySession(a10, b10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(cY, a10, "verify"), bodyParams: { token: b10 } });
        }
        async getToken(a10, b10, c10) {
          this.requireId(a10);
          let d10 = { method: "POST", path: b10 ? ci(cY, a10, "tokens", b10) : ci(cY, a10, "tokens") };
        ...
        async refreshSession(a10, b10) {
          ...
          return this.request({ method: "POST", path: ci(cY, a10, "refresh"), bodyParams: d10, queryParams: { suffixed_cookies: c10 } });
        }
      }, c$ = "/sign_in_tokens", c_ = class extends cj {
        async createSignInToken(a10) {
          return this.request({ method: "POST", path: c$, bodyParams: a10 });
        }
        async revokeSignInToken(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(c$, a10, "revoke") });
        }
      }, c0 = "/sign_ups", c1 = class extends cj {
        async get(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(c0, a10) });
        }
        async update(a10) {
          let { signUpAttemptId: b10, ...c10 } = a10;
          return this.request({ method: "PATCH", path: ci(c0, b10), bodyParams: c10 });
        }
      }, c2 = class extends cj {
        async createTestingToken() {
          return this.request({ method: "POST", path: "/testing_tokens" });
        }
      }, c3 = "/users", c4 = class extends cj {
        async getUserList(a10 = {}) {
          let { limit: b10, offset: c10, orderBy: d10, ...e10 } = a10, [f10, g10] = await Promise.all([this.request({ method: "GET", path: c3, queryParams: a10 }), this.getCount(e10)]);
          return { data: f10, totalCount: g10 };
        }
        async getUser(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci(c3, a10) });
        }
        async createUser(a10) {
          return this.request({ method: "POST", path: c3, bodyParams: a10 });
        }
        async updateUser(a10, b10 = {}) {
          return this.requireId(a10), this.request({ method: "PATCH", path: ci(c3, a10), bodyParams: b10 });
        }
        async updateUserProfileImage(a10, b10) {
          this.requireId(a10);
          let c10 = new bK.FormData();
          return c10.append("file", b10?.file), this.request({ method: "POST", path: ci(c3, a10, "profile_image"), formData: c10 });
        }
        async updateUserMetadata(a10, b10) {
          return this.requireId(a10), this.request({ method: "PATCH", path: ci(c3, a10, "metadata"), bodyParams: b10 });
        }
        async deleteUser(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(c3, a10) });
        }
        async getCount(a10 = {}) {
          return this.request({ method: "GET", path: ci(c3, "count"), queryParams: a10 });
        }
        async getUserOauthAccessToken(a10, b10) {
          this.requireId(a10);
          let c10 = b10.startsWith("oauth_"), d10 = c10 ? b10 : `oauth_${b10}`;
          return c10 && ba("getUserOauthAccessToken(userId, provider)", "Remove the `oauth_` prefix from the `provider` argument."), this.request({ method: "GET", path: ci(c3, a10, "oauth_access_tokens", d10), queryParams: { paginated: true } });
        }
        async disableUserMFA(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(c3, a10, "mfa") });
        }
        async getOrganizationMembershipList(a10) {
          let { userId: b10, limit: c10, offset: d10 } = a10;
          return this.requireId(b10), this.request({ method: "GET", path: ci(c3, b10, "organization_memberships"), queryParams: { limit: c10, offset: d10 } });
        }
        async getOrganizationInvitationList(a10) {
          let { userId: b10, ...c10 } = a10;
          return this.requireId(b10), this.request({ method: "GET", path: ci(c3, b10, "organization_invitations"), queryParams: c10 });
        }
        async verifyPassword(a10) {
          let { userId: b10, password: c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: ci(c3, b10, "verify_password"), bodyParams: { password: c10 } });
        }
        async verifyTOTP(a10) {
          let { userId: b10, code: c10 } = a10;
          return this.requireId(b10), this.request({ method: "POST", path: ci(c3, b10, "verify_totp"), bodyParams: { code: c10 } });
        }
        async banUser(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(c3, a10, "ban") });
        }
        async unbanUser(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(c3, a10, "unban") });
        }
        async lockUser(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(c3, a10, "lock") });
        }
        async unlockUser(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(c3, a10, "unlock") });
        }
        async deleteUserProfileImage(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(c3, a10, "profile_image") });
        }
        async deleteUserPasskey(a10) {
          return this.requireId(a10.userId), this.requireId(a10.passkeyIdentificationId), this.request({ method: "DELETE", path: ci(c3, a10.userId, "passkeys", a10.passkeyIdentificationId) });
        }
        async deleteUserWeb3Wallet(a10) {
          return this.requireId(a10.userId), this.requireId(a10.web3WalletIdentificationId), this.request({ method: "DELETE", path: ci(c3, a10.userId, "web3_wallets", a10.web3WalletIdentificationId) });
        }
        async deleteUserExternalAccount(a10) {
          return this.requireId(a10.userId), this.requireId(a10.externalAccountId), this.request({ method: "DELETE", path: ci(c3, a10.userId, "external_accounts", a10.externalAccountId) });
        }
        async deleteUserBackupCodes(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(c3, a10, "backup_code") });
        }
        async deleteUserTOTP(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(c3, a10, "totp") });
        }
        async setPasswordCompromised(a10, b10 = { revokeAllSessions: false }) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(c3, a10, "password", "set_compromised"), bodyParams: b10 });
        }
        async unsetPasswordCompromised(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(c3, a10, "password", "unset_compromised") });
        }
      }, c5 = "/waitlist_entries", c6 = class extends cj {
        async list(a10 = {}) {
          return this.request({ method: "GET", path: c5, queryParams: a10 });
        }
        async create(a10) {
          return this.request({ method: "POST", path: c5, bodyParams: a10 });
        }
        async invite(a10, b10 = {}) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(c5, a10, "invite"), bodyParams: b10 });
        }
        async reject(a10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci(c5, a10, "reject") });
        }
        async delete(a10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(c5, a10) });
        }
      }, c7 = "/webhooks", c8 = class extends cj {
        async createSvixApp() {
          return this.request({ method: "POST", path: ci(c7, "svix") });
        }
        async generateSvixAuthURL() {
          return this.request({ method: "POST", path: ci(c7, "svix_url") });
        }
        async deleteSvixApp() {
          return this.request({ method: "DELETE", path: ci(c7, "svix") });
        }
      }, c9 = "/billing", da = class extends cj {
        async getPlanList(a10) {
          return this.request({ method: "GET", path: ci(c9, "plans"), queryParams: a10 });
        }
        async cancelSubscriptionItem(a10, b10) {
          return this.requireId(a10), this.request({ method: "DELETE", path: ci(c9, "subscription_items", a10), queryParams: b10 });
        }
        async extendSubscriptionItemFreeTrial(a10, b10) {
          return this.requireId(a10), this.request({ method: "POST", path: ci("/billing", "subscription_items", a10, "extend_free_trial"), bodyParams: b10 });
        }
        async getOrganizationBillingSubscription(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci("/organizations", a10, "billing", "subscription") });
        }
        async getUserBillingSubscription(a10) {
          return this.requireId(a10), this.request({ method: "GET", path: ci("/users", a10, "billing", "subscription") });
        }
      }, db = (a10) => "object" == typeof a10 && null !== a10, dc = (a10) => db(a10) && !(a10 instanceof RegExp) && !(a10 instanceof Error) && !(a10 instanceof Date) && !(globalThis.Blob && a10 instanceof globalThis.Blob), dd = Symbol("mapObjectSkip"), de = (a10, b10, c10, d10 = /* @__PURE__ */ new WeakMap()) => {
        if (c10 = { deep: false, target: {}, ...c10 }, d10.has(a10)) return d10.get(a10);
        d10.set(a10, c10.target);
        let { target: e10 } = c10;
        delete c10.target;
        let f10 = (a11) => a11.map((a12) => dc(a12) ? de(a12, b10, c10, d10) : a12);
        ...
        for (let [g10, h2] of Object.entries(a10)) {
          ...
          "__proto__" !== j2 && (c10.deep && l2 && dc(k2) && (k2 = Array.isArray(k2) ? f10(k2) : de(k2, b10, c10, d10)), e10[j2] = k2);
        }
        return e10;
      };
      function df(a10, b10, c10) {
        if (!db(a10)) throw TypeError(`Expected an object, got \`${a10}\` (${typeof a10})`);
        if (Array.isArray(a10)) throw TypeError("Expected an object, got an array");
        return de(a10, b10, c10);
      }
      var dg = /([\p{Ll}\d])(\p{Lu})/gu, dh = /(\p{Lu})([\p{Lu}][\p{Ll}])/gu, di = /(\d)\p{Ll}|(\p{L})\d/u, dj = /[^\p{L}\d]+/giu, dk = "$1\0$2";
      function dl(a10) {
        let b10 = a10.trim();
        b10 = (b10 = b10.replace(dg, dk).replace(dh, dk)).replace(dj, "\0");
      ...
      function dm(a10) {
        ...
        for (let a11 = 0; a11 < b10.length; a11++) {
          let c10 = b10[a11], d10 = di.exec(c10);
          if (d10) {
      ...
      function dn(a10, b10) {
        ...
        let [e10, f10, g10] = function(a11, b11 = {}) {
          let c11 = b11.split ?? (b11.separateNumbers ? dm : dl), d11 = b11.prefixCharacters ?? "", e11 = b11.suffixCharacters ?? "", f11 = 0, g11 = a11.length;
          for (; f11 < a11.length; ) {
      ...
      var ds = function(a10, b10) {
        if (Array.isArray(a10)) {
          if (a10.some((a11) => a11.constructor !== dp)) throw Error("obj must be array of plain objects");
          let c11 = (b10 = { deep: true, exclude: [], parsingOptions: {}, ...b10 }).snakeCase || ((a11) => dn(a11, b10.parsingOptions));
          return a10.map((a11) => df(a11, (a12, d10) => [dq(b10.exclude, a12) ? a12 : c11(a12), d10, dr(a12, d10, b10)], b10));
        }
        if (a10.constructor !== dp) throw Error("obj must be an plain object");
        let c10 = (b10 = { deep: true, exclude: [], parsingOptions: {}, ...b10 }).snakeCase || ((a11) => dn(a11, b10.parsingOptions));
        return df(a10, (a11, d10) => [dq(b10.exclude, a11) ? a11 : c10(a11), d10, dr(a11, d10, b10)], b10);
      }, dt = class a10 {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.client_id, b10.user_id, b10.status, b10.last_active_at, b10.expire_at, b10.abandon_at, b10.created_at, b10.updated_at, b10.last_active_organization_id, b10.latest_activity && dy.fromJSON(b10.latest_activity), b10.actor);
        }
      }, dA = class a10 {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.session_ids, b10.sessions.map((a11) => dz.fromJSON(a11)), b10.sign_in_id, b10.sign_up_id, b10.last_active_session_id, b10.last_authentication_strategy, b10.created_at, b10.updated_at);
        }
      }, dB = class a10 {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.name, b10.is_satellite, b10.frontend_api_url, b10.development_origin, b10.cname_targets && b10.cname_targets.map((a11) => dB.fromJSON(a11)), b10.accounts_portal_url, b10.proxy_url);
        }
      }, dF = class a10 {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.email_address, b10.verification && dH.fromJSON(b10.verification), b10.linked_to.map((a11) => dG.fromJSON(a11)));
        }
      }, dJ = class a10 {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.provider, b10.identification_id, b10.provider_user_id, b10.approved_scopes, b10.email_address, b10.first_name, b10.last_name, b10.image_url || "", b10.username, b10.phone_number, b10.public_metadata, b10.label, b10.verification && dH.fromJSON(b10.verification));
        }
      }, dK = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h2, i2, j2, k2) {
        ...
        static fromJSON(b10) {
          let c10 = new a10(b10.id, b10.role, b10.permissions, b10.public_metadata, b10.private_metadata, b10.created_at, b10.updated_at, dX.fromJSON(b10.organization), d$.fromJSON(b10.public_user_data));
          return c10._raw = b10, c10;
        }
      }, d$ = class a10 {
        constructor(a11, b10, c10, d10, e10, f10) {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.phone_number, b10.reserved_for_second_factor, b10.default_second_factor, b10.verification && dH.fromJSON(b10.verification), b10.linked_to.map((a11) => dG.fromJSON(a11)));
        }
      }, d1 = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10) {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.name, b10.domain, b10.organization_id, b10.idp_entity_id, b10.idp_sso_url, b10.idp_certificate, b10.idp_metadata_url, b10.idp_metadata, b10.acs_url, b10.sp_entity_id, b10.sp_metadata_url, b10.active, b10.provider, b10.user_count, b10.sync_user_attributes, b10.allow_subdomains, b10.allow_idp_initiated, b10.created_at, b10.updated_at, b10.attribute_mapping && d5.fromJSON(b10.attribute_mapping));
        }
      }, d4 = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h2, i2, j2) {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.provider, b10.provider_user_id, b10.active, b10.email_address, b10.first_name, b10.last_name, b10.verification && dH.fromJSON(b10.verification), b10.saml_connection && d4.fromJSON(b10.saml_connection), b10.last_authenticated_at ?? null, b10.enterprise_connection_id);
        }
      }, d7 = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10) {
        ...
        static fromJSON(b10) {
          return new a10(b10.email_address && d8.fromJSON(b10.email_address), b10.phone_number && d8.fromJSON(b10.phone_number), b10.web3_wallet && d8.fromJSON(b10.web3_wallet), b10.external_account);
        }
      }, ea = class a10 {
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.web3_wallet, b10.verification && dH.fromJSON(b10.verification));
        }
      }, ee = class a10 {
        ...
        static fromJSON(b10) {
          let c10 = new a10(b10.id, b10.password_enabled, b10.totp_enabled, b10.backup_code_enabled, b10.two_factor_enabled, b10.banned, b10.locked, b10.created_at, b10.updated_at, b10.image_url, b10.has_image, b10.primary_email_address_id, b10.primary_phone_number_id, b10.primary_web3_wallet_id, b10.last_sign_in_at, b10.external_id, b10.username, b10.first_name, b10.last_name, b10.public_metadata, b10.private_metadata, b10.unsafe_metadata, (b10.email_addresses || []).map((a11) => dI.fromJSON(a11)), (b10.phone_numbers || []).map((a11) => d0.fromJSON(a11)), (b10.web3_wallets || []).map((a11) => ed.fromJSON(a11)), (b10.external_accounts || []).map((a11) => dJ.fromJSON(a11)), (b10.saml_accounts || []).map((a11) => d6.fromJSON(a11)), b10.last_active_at, b10.create_organization_enabled, b10.create_organizations_limit, b10.delete_self_enabled, b10.legal_accepted_at, b10.locale);
          return c10._raw = b10, c10;
        }
        ...
        static fromJSON(b10) {
          return new a10(b10.id, b10.email_address, b10.status, b10.invitation && dO.fromJSON(b10.invitation), b10.created_at, b10.updated_at, b10.is_locked);
        }
      }, eg = class a10 {
        constructor(a11, b10, c10, d10, e10) {
        ...
        static fromJSON(b10) {
          ...
          return new a10(b10.id, b10.name, b10.slug, b10.description ?? null, b10.is_default, b10.is_recurring, b10.has_base_fee, b10.publicly_visible, c10(b10.fee), c10(b10.annual_fee), c10(b10.annual_monthly_fee), b10.for_payer_type, (b10.features ?? []).map((a11) => eg.fromJSON(a11)));
        }
      }, ei = class a10 {
        ...
        static fromJSON(b10) {
          ...
          return new a10(b10.id, b10.status, b10.plan_period, b10.period_start, b10.next_payment, c10(b10.amount) ?? void 0, b10.plan ? eh.fromJSON(b10.plan) : null, b10.plan_id ?? null, b10.created_at, b10.updated_at, b10.period_end, b10.canceled_at, b10.past_due_at, b10.ended_at, b10.payer_id, b10.is_free_trial, c10(b10.lifetime_paid) ?? void 0);
        }
      }, ej = class a10 {
        constructor(a11, b10, c10, d10, e10, f10, g10, h2, i2, j2) {
        ...
        static fromJSON(b10) {
          ...
          return new a10(b10.id, b10.status, b10.payer_id, b10.created_at, b10.updated_at, b10.active_at ?? null, b10.past_due_at ?? null, (b10.subscription_items ?? []).map((a11) => ei.fromJSON(a11)), c10, b10.eligible_for_free_trial ?? false);
        }
      };
      function ek(a10) {
        if ("string" != typeof a10 && "object" in a10 && "deleted" in a10) return dD.fromJSON(a10);
        switch (a10.object) {
          case dP.AccountlessApplication:
            return dt.fromJSON(a10);
          case dP.ActorToken:
            return du.fromJSON(a10);
          case dP.AllowlistIdentifier:
            return dv.fromJSON(a10);
          case dP.ApiKey:
            return dw.fromJSON(a10);
          case dP.BlocklistIdentifier:
          ...
          case dP.MachineScope:
            return dR.fromJSON(a10);
          case dP.MachineSecretKey:
            return dS.fromJSON(a10);
          case dP.M2MToken:
            return dT.fromJSON(a10);
          case dP.OauthAccessToken:
            return dV.fromJSON(a10);
          case dP.OAuthApplication:
            return dW.fromJSON(a10);
          case dP.Organization:
            return dX.fromJSON(a10);
          case dP.OrganizationInvitation:
            return dY.fromJSON(a10);
          case dP.OrganizationMembership:
            return dZ.fromJSON(a10);
          case dP.OrganizationSettings:
          ...
          case dP.WaitlistEntry:
            return ef.fromJSON(a10);
          case dP.BillingPlan:
            return eh.fromJSON(a10);
          case dP.BillingSubscription:
            return ej.fromJSON(a10);
          case dP.BillingSubscriptionItem:
      ...
      function el(a10) {
        ...
        return b10 = async (b11) => {
          let c10, { secretKey: d10, machineSecretKey: e10, useMachineSecretKey: f10 = false, requireSecretKey: g10 = true, apiUrl: h2 = b4, apiVersion: i2 = "v1", userAgent: j2 = b5, skipApiVersionInUrl: k2 = false } = a10, { path: l2, method: m2, queryParams: n2, headerParams: o2, bodyParams: p2, formData: q2, options: r2 } = b11, { deepSnakecaseBodyParamKeys: s2 = false } = r2 || {};
          g10 && cd(d10);
          let t2 = new URL(k2 ? ci(h2, l2) : ci(h2, i2, l2));
          if (n2) for (let [a11, b12] of Object.entries(ds({ ...n2 }))) b12 && [b12].flat().forEach((b13) => t2.searchParams.append(a11, b13));
          let u2 = new Headers({ "Clerk-API-Version": b6, [b9.Headers.UserAgent]: j2, ...o2 }), v2 = b9.Headers.Authorization;
          !u2.has(v2) && (f10 && e10 ? u2.set(v2, `Bearer ${e10}`) : d10 && u2.set(v2, `Bearer ${d10}`));
          try {
            var w2;
            q2 ? c10 = await bK.fetch(t2.href, { method: m2, headers: u2, body: q2 }) : (u2.set("Content-Type", "application/json"), c10 = await bK.fetch(t2.href, { method: m2, headers: u2, ...(() => {
              if (!("GET" !== m2 && p2 && Object.keys(p2).length > 0)) return null;
              let a12 = (a13) => ds(a13, { deep: s2 });
              return { body: JSON.stringify(Array.isArray(p2) ? p2.map(a12) : a12(p2)) };
            })() }));
            let a11 = c10?.headers && c10.headers?.get(b9.Headers.ContentType) === b9.ContentTypes.Json, b12 = await (a11 ? c10.json() : c10.text());
            if (!c10.ok) return { data: null, errors: eo(b12), status: c10?.status, statusText: c10?.statusText, clerkTraceId: em(b12, c10?.headers), retryAfter: en(c10?.headers) };
            return { ...Array.isArray(b12) ? { data: b12.map((a12) => ek(a12)) } : (w2 = b12) && "object" == typeof w2 && "data" in w2 && Array.isArray(w2.data) && void 0 !== w2.data ? { data: b12.data.map((a12) => ek(a12)), totalCount: b12.total_count } : { data: ek(b12) }, errors: null };
          } catch (a11) {
            if (a11 instanceof Error) return { data: null, errors: [{ code: "unexpected_error", message: a11.message || "Unexpected error" }], clerkTraceId: em(a11, c10?.headers) };
            return { data: null, errors: eo(a11), status: c10?.status, statusText: c10?.statusText, clerkTraceId: em(a11, c10?.headers), retryAfter: en(c10?.headers) };
          }
        }, async (...a11) => {
          let { data: c10, errors: d10, totalCount: e10, status: f10, statusText: g10, clerkTraceId: h2, retryAfter: i2 } = await b10(...a11);
          if (d10) {
            let a12 = new bw(g10 || "", { data: [], status: f10, clerkTraceId: h2, retryAfter: i2 });
      ...
      function ep(a10) {
        let b10 = el(a10);
        return { __experimental_accountlessApplications: new cn(el({ ...a10, requireSecretKey: false })), actorTokens: new cl(b10), allowlistIdentifiers: new cp(b10), apiKeys: new cr(el({ ...a10, skipApiVersionInUrl: true })), betaFeatures: new cs(b10), blocklistIdentifiers: new cu(b10), billing: new da(b10), clients: new cw(b10), domains: new cy(b10), emailAddresses: new cA(b10), idPOAuthAccessToken: new cB(el({ ...a10, skipApiVersionInUrl: true })), instance: new cD(b10), invitations: new cF(b10), jwks: new cK(b10), jwtTemplates: new cM(b10), machines: new cH(b10), m2m: new cJ(el({ ...a10, skipApiVersionInUrl: true, requireSecretKey: false, useMachineSecretKey: true })), oauthApplications: new cQ(b10), organizations: new cO(b10), phoneNumbers: new cS(b10), proxyChecks: new cT(b10), redirectUrls: new cV(b10), samlConnections: new cX(b10), sessions: new cZ(b10), signInTokens: new c_(b10), signUps: new c1(b10), testingTokens: new c2(b10), users: new c4(b10), waitlistEntries: new c6(b10), webhooks: new c8(b10) };
      }
      var eq = "oat_", er = ["mt_", eq, "ak_"], es = /^[a-zA-Z0-9\-_]+\.[a-zA-Z0-9\-_]+\.[a-zA-Z0-9\-_]+$/;
      function et(a10) {
        return es.test(a10);
      }
      var eu = ["at+jwt", "application/at+jwt"];
      function ev(a10) {
        if (!et(a10)) return false;
        try {
          let { data: b10, errors: c10 } = bU(a10);
          return !c10 && !!b10 && eu.includes(b10.header.typ);
        } catch {
          return false;
        }
      }
      function ew(a10) {
        return er.some((b10) => a10.startsWith(b10));
      }
      function ex(a10) {
        return ew(a10) || ev(a10);
      }
      function ey(a10) {
        if (a10.startsWith("mt_")) return ce.M2MToken;
        if (a10.startsWith(eq) || ev(a10)) return ce.OAuthToken;
        if (a10.startsWith("ak_")) return ce.ApiKey;
        throw Error("Unknown machine token type");
      }
      var ez = (a10, b10) => !!a10 && ("any" === b10 || (Array.isArray(b10) ? b10 : [b10]).includes(a10)), eA = (a10) => () => {
        let b10 = { ...a10 };
        return b10.secretKey = (b10.secretKey || "").substring(0, 7), b10.jwtKey = (b10.jwtKey || "").substring(0, 7), { ...b10 };
      };
      function eB(a10, b10) {
        return { tokenType: ce.SessionToken, sessionClaims: null, sessionId: null, sessionStatus: b10 ?? null, userId: null, actor: null, orgId: null, orgRole: null, orgSlug: null, orgPermissions: null, factorVerificationAge: null, getToken: () => Promise.resolve(null), has: () => false, debug: eA(a10), isAuthenticated: false };
      }
      function eC(a10, b10) {
        let c10 = { id: null, subject: null, scopes: null, has: () => false, getToken: () => Promise.resolve(null), debug: eA(b10), isAuthenticated: false };
        switch (a10) {
          case ce.ApiKey:
        ...
        return { status: eF.SignedIn, reason: null, message: null, proxyUrl: b10.proxyUrl || "", publishableKey: b10.publishableKey || "", isSatellite: b10.isSatellite || false, domain: b10.domain || "", signInUrl: b10.signInUrl || "", signUpUrl: b10.signUpUrl || "", afterSignInUrl: b10.afterSignInUrl || "", afterSignUpUrl: b10.afterSignUpUrl || "", isSignedIn: true, isAuthenticated: true, tokenType: a10.tokenType, toAuth: ({ treatPendingAsSignedOut: c11 = true } = {}) => {
          if (a10.tokenType === ce.SessionToken) {
            let { sessionClaims: e11 } = a10, f11 = function(a11, b11, c12) {
              let d11, { actor: e12, sessionId: f12, sessionStatus: g11, userId: h2, orgId: i2, orgRole: j2, orgSlug: k2, orgPermissions: l2, factorVerificationAge: m2 } = ((a12) => {
                ...
                if (2 === a12.v) {
                  if (a12.o) {
                    ...
                    let { org: f14 } = b2(a12.fea), { permissions: g13, featurePermissionMap: h3 } = (({ per: a13, fpm: b13 }) => {
              ...
              return { tokenType: ce.SessionToken, actor: e12, sessionClaims: c12, sessionId: f12, sessionStatus: g11, userId: h2, orgId: i2, orgRole: j2, orgSlug: k2, orgPermissions: l2, factorVerificationAge: m2, getToken: o2, has: (d11 = { orgId: i2, orgRole: j2, orgPermissions: l2, userId: h2, factorVerificationAge: m2, features: c12.fea || "", plans: c12.pla || "" }, (a12) => {
                if (!d11.userId) return false;
                let b12 = ((a13, b13) => {
                  let { features: c14, plans: d12 } = b13;
                  return a13.feature && c14 ? b1(c14, a13.feature) : a13.plan && d12 ? b1(d12, a13.plan) : null;
                })(a12, d11), c13 = ((a13, b13) => {
                  let { orgId: c14, orgRole: d12, orgPermissions: e14 } = b13;
                  return (a13.role || a13.permission) && c14 && d12 && e14 ? a13.permission ? e14.includes(b0(a13.permission)) : a13.role ? b0(d12) === b0(a13.role) : null : null;
                })(a12, d11), e13 = ((a13, { factorVerificationAge: b13 }) => {
                  if (!a13.reverification || !b13) return null;
                  let c14 = ((a14) => {
                    let b14, c15;
                    if (!a14) return false;
                    let d13 = "string" == typeof a14 && b_.has(a14), e15 = "object" == typeof a14 && (b14 = a14.level, b$.has(b14)) && "number" == typeof (c15 = a14.afterMinutes) && c15 > 0;
                    return (!!d13 || !!e15) && ((a15) => "string" == typeof a15 ? bZ[a15] : a15).bind(null, a14);
                  })(a13.reverification);
                  if (!c14) return null;
              ...
              }), debug: eA({ ...a11, sessionToken: b11 }), isAuthenticated: true };
            }(b10, d10, e11);
            return c11 && "pending" === f11.sessionStatus ? eB(void 0, f11.sessionStatus) : f11;
          }
          let { machineData: e10 } = a10;
          var f10 = a10.tokenType;
          let g10 = { id: e10.id, subject: e10.subject, getToken: () => Promise.resolve(d10), has: () => false, debug: eA(b10), isAuthenticated: true };
          switch (f10) {
            case ce.ApiKey:
      ...
      function eI(a10) {
        ...
        return eJ({ status: eF.SignedOut, reason: d10, message: e10, proxyUrl: b10.proxyUrl || "", publishableKey: b10.publishableKey || "", isSatellite: b10.isSatellite || false, domain: b10.domain || "", signInUrl: b10.signInUrl || "", signUpUrl: b10.signUpUrl || "", afterSignInUrl: b10.afterSignInUrl || "", afterSignUpUrl: b10.afterSignUpUrl || "", isSignedIn: false, isAuthenticated: false, tokenType: f10, toAuth: () => f10 === ce.SessionToken ? eB({ ...b10, status: eF.SignedOut, reason: d10, message: e10 }) : eC(f10, { reason: d10, message: e10, headers: c10 }), headers: c10, token: null });
      }
      var eJ = (a10) => {
        let b10 = new Headers(a10.headers || {});
        if (a10.message) try {
          b10.set(b9.Headers.AuthMessage, a10.message);
        } catch {
        }
        if (a10.reason) try {
          b10.set(b9.Headers.AuthReason, a10.reason);
        } catch {
        }
        if (a10.status) try {
          b10.set(b9.Headers.AuthStatus, a10.status);
        } catch {
        }
        return a10.headers = b10, a10;
      }, eK = class extends URL {
        isCrossOrigin(a10) {
          return this.origin !== new URL(a10.toString()).origin;
        }
      }, eL = (...a10) => new eK(...a10), eM = class extends Request {
        constructor(a10, b10) {
        ...
        deriveUrlFromHeaders(a10) {
          let b10 = new URL(a10.url), c10 = a10.headers.get(b9.Headers.ForwardedProto), d10 = a10.headers.get(b9.Headers.ForwardedHost), e10 = a10.headers.get(b9.Headers.Host), f10 = b10.protocol, g10 = this.getFirstValueFromHeader(d10) ?? e10, h2 = this.getFirstValueFromHeader(c10) ?? f10?.replace(/[:/]/, ""), i2 = g10 && h2 ? `${h2}://${g10}` : b10.origin;
          return i2 === b10.origin ? eL(b10) : eL(b10.pathname + b10.search, i2);
        }
        getFirstValueFromHeader(a10) {
          return a10?.split(",")[0];
        }
        parseCookies(a10) {
          return new Map(Object.entries((0, b3.qg)(this.decodeCookieValue(a10.headers.get("cookie") || ""))));
        }
        decodeCookieValue(a10) {
          return a10 ? a10.replace(/(%[0-9A-Z]{2})+/g, decodeURIComponent) : a10;
        }
      }, eN = (...a10) => a10[0] && "object" == typeof a10[0] && "clerkUrl" in a10[0] && "cookies" in a10[0] ? a10[0] : new eM(...a10), eO = (a10) => a10.split(";")[0]?.split("=")[0], eP = (a10) => a10.split(";")[0]?.split("=")[1], eQ = {}, eR = 0;
      function eS(a10, b10, c10 = true) {
        eQ[a10] = b10, eR = c10 ? Date.now() : -1;
      }
      function eT(a10) {
        let { kid: b10, pem: c10 } = a10, d10 = `local-${b10}`, e10 = eQ[d10];
        if (e10) return e10;
        if (!c10) throw new bF({ action: bE.SetClerkJWTKey, message: "Missing local JWK.", reason: bD.LocalJWKMissing });
        ...
        return eS(d10, f10, false), f10;
      }
      async function eU(a10) {
        let { secretKey: b10, apiUrl: c10 = b4, apiVersion: d10 = "v1", kid: e10, skipJwksCache: f10 } = a10;
        if (f10 || function() {
          if (-1 === eR) return false;
          let a11 = Date.now() - eR >= 3e5;
          return a11 && (eQ = {}), a11;
        }() || !eQ[e10]) {
          if (!b10) throw new bF({ action: bE.ContactSupport, message: "Failed to load JWKS from Clerk Backend or Frontend API.", reason: bD.RemoteJWKFailedToLoad });
          let { keys: a11 } = await br(() => eV(c10, b10, d10));
          if (!a11 || !a11.length) throw new bF({ action: bE.ContactSupport, message: "The JWKS endpoint did not contain any signing keys. Contact support@clerk.com.", reason: bD.RemoteJWKFailedToLoad });
          a11.forEach((a12) => eS(a12.kid, a12));
        }
        let g10 = eQ[e10];
        if (!g10) {
          let a11 = Object.values(eQ).map((a12) => a12.kid).sort().join(", ");
          throw new bF({ action: `Go to your Dashboard and validate your secret and public keys are correct. ${bE.ContactSupport} if the issue persists.`, message: `Unable to find a signing key in JWKS that matches the kid='${e10}' of the provided session token. Please make sure that the __session cookie or the HTTP authorization header contain a Clerk-generated session JWT. The following kid is available: ${a11}`, reason: bD.JWKKidMismatch });
        }
        return g10;
      }
      async function eV(a10, b10, c10) {
        if (!b10) throw new bF({ action: bE.SetClerkSecretKey, message: "Missing Clerk Secret Key or API Key. Go to https://dashboard.clerk.com and get your key for your instance.", reason: bD.RemoteJWKFailedToLoad });
        let d10 = new URL(a10);
        d10.pathname = ci(d10.pathname, c10, "/jwks");
        let e10 = await bK.fetch(d10.href, { headers: { Authorization: `Bearer ${b10}`, "Clerk-API-Version": b6, "Content-Type": "application/json", "User-Agent": b5 } });
        if (!e10.ok) {
          let a11 = await e10.json(), b11 = eW(a11?.errors, bC.InvalidSecretKey);
          if (b11) {
            let a12 = bD.InvalidSecretKey;
            throw new bF({ action: bE.ContactSupport, message: b11.message, reason: a12 });
          }
          throw new bF({ action: bE.ContactSupport, message: `Error loading Clerk JWKS from ${d10.href} with code=${e10.status}`, reason: bD.RemoteJWKFailedToLoad });
        }
        return e10.json();
      }
      var eW = (a10, b10) => a10 ? a10.find((a11) => a11.code === b10) : null;
      async function eX(a10, b10) {
        let { data: c10, errors: d10 } = bU(a10);
        if (d10) return { errors: d10 };
        let { header: e10 } = c10, { kid: f10 } = e10;
        try {
          let c11;
          if (b10.jwtKey) c11 = eT({ kid: f10, pem: b10.jwtKey });
          else {
            if (!b10.secretKey) return { errors: [new bF({ action: bE.SetClerkJWTKey, message: "Failed to resolve JWK during verification.", reason: bD.JWKFailedToResolve })] };
            c11 = await eU({ ...b10, kid: f10 });
          }
          return await bV(a10, { ...b10, key: c11 });
        } catch (a11) {
          return { errors: [a11] };
        }
      }
      function eY(a10, b10, c10) {
        if (bx(b10)) {
          ...
          switch (b10.status) {
            case 401:
              d10 = bG.InvalidSecretKey, e10 = b10.errors[0]?.message || "Invalid secret key";
              break;
            case 404:
              d10 = bG.TokenInvalid, e10 = c10;
              break;
            default:
              d10 = bG.UnexpectedError, e10 = "Unexpected error";
          }
          return { data: void 0, tokenType: a10, errors: [new bH({ message: e10, code: d10, status: b10.status })] };
        }
        return { data: void 0, tokenType: a10, errors: [new bH({ message: "Unexpected error", code: bG.UnexpectedError, status: b10.status })] };
      }
      async function eZ(a10, b10) {
        try {
          let c10 = ep(b10);
          return { data: await c10.m2m.verify({ token: a10 }), tokenType: ce.M2MToken, errors: void 0 };
        } catch (a11) {
          return eY(ce.M2MToken, a11, "Machine token not found");
        }
      }
      async function e$(a10, b10) {
        ...
        try {
          ...
          return { data: void 0, tokenType: ce.OAuthToken, errors: [new bH({ code: bG.TokenInvalid, message: a11.message })] };
        }
        let { data: e10, errors: f10 } = c10;
        if (f10) return { data: void 0, tokenType: ce.OAuthToken, errors: [new bH({ code: bG.TokenInvalid, message: f10[0].message })] };
        let { header: g10 } = e10, { kid: h2 } = g10;
        try {
          if (b10.jwtKey) d10 = eT({ kid: h2, pem: b10.jwtKey });
          else {
            if (!b10.secretKey) return { data: void 0, tokenType: ce.OAuthToken, errors: [new bH({ action: bE.SetClerkJWTKey, message: "Failed to resolve JWK during verification.", code: bG.TokenVerificationFailed })] };
            d10 = await eU({ ...b10, kid: h2 });
          }
          let { data: c11, errors: e11 } = await bV(a10, { ...b10, key: d10, headerType: eu });
          if (e11) return { data: void 0, tokenType: ce.OAuthToken, errors: [new bH({ code: bG.TokenVerificationFailed, message: e11[0].message })] };
          return { data: dK.fromJwtPayload(c11, b10.clockSkewInMs), tokenType: ce.OAuthToken, errors: void 0 };
        } catch (a11) {
          return { tokenType: ce.OAuthToken, errors: [new bH({ code: bG.TokenVerificationFailed, message: a11.message })] };
        }
      }
      async function e_(a10, b10) {
        if (et(a10)) return e$(a10, b10);
        try {
          let c10 = ep(b10);
          return { data: await c10.idPOAuthAccessToken.verify(a10), tokenType: ce.OAuthToken, errors: void 0 };
        } catch (a11) {
          return eY(ce.OAuthToken, a11, "OAuth token not found");
        }
      }
      async function e0(a10, b10) {
        try {
          let c10 = ep(b10);
          return { data: await c10.apiKeys.verify(a10), tokenType: ce.ApiKey, errors: void 0 };
        } catch (a11) {
          return eY(ce.ApiKey, a11, "API key not found");
        }
      }
      async function e1(a10, b10) {
        if (a10.startsWith("mt_")) return eZ(a10, b10);
        if (a10.startsWith(eq) || et(a10)) return e_(a10, b10);
        if (a10.startsWith("ak_")) return e0(a10, b10);
        throw Error("Unknown machine token type");
      }
      async function e2(a10, { key: b10 }) {
        let { data: c10, errors: d10 } = bU(a10);
        if (d10) throw d10[0];
        let { header: e10, payload: f10 } = c10, { typ: g10, alg: h2 } = e10;
        bR(g10), bS(h2);
        let { data: i2, errors: j2 } = await bT(c10, b10);
        if (j2) throw new bF({ reason: bD.TokenVerificationFailed, message: `Error verifying handshake token. ${j2[0]}` });
        if (!i2) throw new bF({ reason: bD.TokenInvalidSignature, message: "Handshake signature is invalid." });
        return f10;
      }
      async function e3(a10, b10) {
        let c10, { secretKey: d10, apiUrl: e10, apiVersion: f10, jwksCacheTtlInMs: g10, jwtKey: h2, skipJwksCache: i2 } = b10, { data: j2, errors: k2 } = bU(a10);
        if (k2) throw k2[0];
        let { kid: l2 } = j2.header;
        if (h2) c10 = eT({ kid: l2, pem: h2 });
        else if (d10) c10 = await eU({ secretKey: d10, apiUrl: e10, apiVersion: f10, kid: l2, jwksCacheTtlInMs: g10, skipJwksCache: i2 });
        else throw new bF({ action: bE.SetClerkJWTKey, message: "Failed to resolve JWK during handshake verification.", reason: bD.JWKFailedToResolve });
        return e2(a10, { key: c10 });
      }
      var e4 = class {
        constructor(a10, b10, c10) {
        ...
        buildRedirectToHandshake(a10) {
          ...
          d10.searchParams.append("redirect_url", b10?.href || ""), d10.searchParams.append("__clerk_api_version", b6), d10.searchParams.append(b9.QueryParameters.SuffixedCookies, this.authenticateContext.usesSuffixedCookies().toString()), d10.searchParams.append(b9.QueryParameters.HandshakeReason, a10), d10.searchParams.append(b9.QueryParameters.HandshakeFormat, "nonce"), this.authenticateContext.sessionToken && d10.searchParams.append(b9.QueryParameters.Session, this.authenticateContext.sessionToken), "development" === this.authenticateContext.instanceType && this.authenticateContext.devBrowserToken && d10.searchParams.append(b9.QueryParameters.DevBrowser, this.authenticateContext.devBrowserToken);
          ...
          }), new Headers({ [b9.Headers.Location]: d10.href });
        }
        async getCookiesFromHandshake() {
          ...
          if (this.authenticateContext.handshakeNonce) try {
            ...
            let b10 = await e3(this.authenticateContext.handshakeToken, this.authenticateContext);
        ...
        async resolveHandshake() {
          ...
          if (b10.forEach((b11) => {
            a10.append("Set-Cookie", b11), eO(b11).startsWith(b9.Cookies.Session) && (c10 = eP(b11));
          }), "development" === this.authenticateContext.instanceType) {
            let b11 = new URL(this.authenticateContext.clerkUrl);
            b11.searchParams.delete(b9.QueryParameters.Handshake), b11.searchParams.delete(b9.QueryParameters.HandshakeHelp), b11.searchParams.delete(b9.QueryParameters.DevBrowser), b11.searchParams.delete(b9.QueryParameters.HandshakeNonce), a10.append(b9.Headers.Location, b11.toString()), a10.set(b9.Headers.CacheControl, "no-store");
          }
          if ("" === c10) return eI({ tokenType: ce.SessionToken, authenticateContext: this.authenticateContext, reason: eG.SessionTokenMissing, message: "", headers: a10 });
          let { data: d10, errors: [e10] = [] } = await eX(c10, this.authenticateContext);
          if (d10) return eH({ tokenType: ce.SessionToken, authenticateContext: this.authenticateContext, sessionClaims: d10, headers: a10, token: c10 });
          if ("development" === this.authenticateContext.instanceType && (e10?.reason === bD.TokenExpired || e10?.reason === bD.TokenNotActiveYet || e10?.reason === bD.TokenIatInTheFuture)) {
            let b11 = new bF({ action: e10.action, message: e10.message, reason: e10.reason });
...
${b11.getFullMessage()}`);
            let { data: d11, errors: [f10] = [] } = await eX(c10, { ...this.authenticateContext, clockSkewInMs: 864e5 });
            if (d11) return eH({ tokenType: ce.SessionToken, authenticateContext: this.authenticateContext, sessionClaims: d11, headers: a10, token: c10 });
        ...
        handleTokenVerificationErrorInDevelopment(a10) {
          if (a10.reason === bD.TokenInvalidSignature) throw Error("Clerk: Handshake token verification failed due to an invalid signature. If you have switched Clerk keys locally, clear your cookies and try again.");
        ...
        checkAndTrackRedirectLoop(a10) {
          ...
          let b10 = this.authenticateContext.handshakeRedirectLoopCounter + 1, c10 = b9.Cookies.RedirectCount;
          return a10.append("Set-Cookie", `${c10}=${b10}; SameSite=Lax; HttpOnly; Max-Age=2`), false;
        }
        removeDevBrowserFromURL(a10) {
          let b10 = new URL(a10);
          return b10.searchParams.delete(b9.QueryParameters.DevBrowser), b10.searchParams.delete(b9.QueryParameters.LegacyDevBrowser), b10;
        }
...
${a12.message}`);
      ...
      }, e6 = { NonEligibleNoCookie: "non-eligible-no-refresh-cookie", NonEligibleNonGet: "non-eligible-non-get", InvalidSessionToken: "invalid-session-token", MissingApiClient: "missing-api-client", MissingSessionToken: "missing-session-token", MissingRefreshToken: "missing-refresh-token", ExpiredSessionTokenDecodeFailed: "expired-session-token-decode-failed", ExpiredSessionTokenMissingSidClaim: "expired-session-token-missing-sid-claim", FetchError: "fetch-error", UnexpectedSDKError: "unexpected-sdk-error", UnexpectedBAPIError: "unexpected-bapi-error" };
      function e7(a10, b10, c10) {
        return ez(a10, b10) ? null : eI({ tokenType: "string" == typeof b10 ? b10 : a10, authenticateContext: c10, reason: eG.TokenTypeMismatch });
      }
      var e8 = async (a10, b10) => {
        let c10 = await cg(eN(a10), b10), d10 = b10.acceptsToken ?? ce.SessionToken;
        if (d10 !== ce.M2MToken && (cd(c10.secretKey), c10.isSatellite)) {
        ...
        let g10 = new e5(b10.organizationSyncOptions), h2 = new e4(c10, { organizationSyncOptions: b10.organizationSyncOptions }, g10);
        async function i2(c11) {
          if (!b10.apiClient) return { data: null, error: { message: "An apiClient is needed to perform token refresh.", cause: { reason: e6.MissingApiClient } } };
          let { sessionToken: d11, refreshTokenInCookie: e11 } = c11;
          if (!d11) return { data: null, error: { message: "Session token must be provided.", cause: { reason: e6.MissingSessionToken } } };
          if (!e11) return { data: null, error: { message: "Refresh token must be provided.", cause: { reason: e6.MissingRefreshToken } } };
          let { data: f11, errors: g11 } = bU(d11);
          if (!f11 || g11) return { data: null, error: { message: "Unable to decode the expired session token.", cause: { reason: e6.ExpiredSessionTokenDecodeFailed, errors: g11 } } };
          if (!f11?.payload?.sid) return { data: null, error: { message: "Expired session token is missing the `sid` claim.", cause: { reason: e6.ExpiredSessionTokenMissingSidClaim } } };
          try {
            ...
            if (!a11?.errors?.length) return { data: null, error: { message: "Unexpected Server/BAPI error", cause: { reason: e6.UnexpectedBAPIError, errors: [a11] } } };
            if ("unexpected_error" === a11.errors[0].code) return { data: null, error: { message: "Fetch unexpected error", cause: { reason: e6.FetchError, errors: a11.errors } } };
        ...
        async function j2(a11) {
          ...
          b11.forEach((a12) => {
            d11.append("Set-Cookie", a12), eO(a12).startsWith(b9.Cookies.Session) && (e11 = eP(a12));
          });
          let { data: f11, errors: g11 } = await eX(e11, a11);
          return g11 ? { data: null, error: { message: "Clerk: unable to verify refreshed session token.", cause: { reason: e6.InvalidSessionToken, errors: g11 } } } : { data: { jwtPayload: f11, sessionToken: e11, headers: d11 }, error: null };
        }
        function k2(a11, b11, c11, d11) {
          if (!h2.isRequestEligibleForHandshake()) return eI({ tokenType: ce.SessionToken, authenticateContext: a11, reason: b11, message: c11 });
          let e11 = d11 ?? h2.buildRedirectToHandshake(b11);
          return (e11.get(b9.Headers.Location) && e11.set(b9.Headers.CacheControl, "no-store"), h2.checkAndTrackRedirectLoop(e11)) ? (console.log("Clerk: Refreshing the session token resulted in an infinite redirect loop. This usually means that your Clerk instance keys do not match - make sure to copy the correct publishable and secret keys from the Clerk dashboard."), eI({ tokenType: ce.SessionToken, authenticateContext: a11, reason: b11, message: c11 })) : function(a12, b12, c12 = "", d12) {
            return eJ({ status: eF.Handshake, reason: b12, message: c12, publishableKey: a12.publishableKey || "", isSatellite: a12.isSatellite || false, domain: a12.domain || "", proxyUrl: a12.proxyUrl || "", signInUrl: a12.signInUrl || "", signUpUrl: a12.signUpUrl || "", afterSignInUrl: a12.afterSignInUrl || "", afterSignUpUrl: a12.afterSignUpUrl || "", isSignedIn: false, isAuthenticated: false, tokenType: ce.SessionToken, toAuth: () => null, headers: d12, token: null });
          }(a11, b11, c11, e11);
        }
        async function l2() {
          let { tokenInHeader: a11 } = c10;
          try {
            let { data: b11, errors: d11 } = await eX(a11, c10);
            if (d11) throw d11[0];
            return eH({ tokenType: ce.SessionToken, authenticateContext: c10, sessionClaims: b11, headers: new Headers(), token: a11 });
          } catch (a12) {
        ...
        async function m2() {
          ...
          if (c10.handshakeNonce || c10.handshakeToken) try {
            ...
            a12 instanceof bF && "development" === c10.instanceType ? h2.handleTokenVerificationErrorInDevelopment(a12) : console.error("Clerk: unable to resolve handshake:", a12);
          }
          let e11 = c10.isSatellite && "document" === c10.secFetchDest;
          if ("production" === c10.instanceType && e11) return k2(c10, eG.SatelliteCookieNeedsSyncing, "");
          if ("development" === c10.instanceType && e11 && !c10.clerkUrl.searchParams.has(b9.QueryParameters.ClerkSynced)) {
            let a12 = new URL(c10.signInUrl);
            a12.searchParams.append(b9.QueryParameters.ClerkRedirectUrl, c10.clerkUrl.toString());
            let b12 = new Headers({ [b9.Headers.Location]: a12.toString() });
            return k2(c10, eG.SatelliteCookieNeedsSyncing, "", b12);
          }
          let f11 = new URL(c10.clerkUrl).searchParams.get(b9.QueryParameters.ClerkRedirectUrl);
          if ("development" === c10.instanceType && !c10.isSatellite && f11) {
            let a12 = new URL(f11);
            c10.devBrowserToken && a12.searchParams.append(b9.QueryParameters.DevBrowser, c10.devBrowserToken), a12.searchParams.append(b9.QueryParameters.ClerkSynced, "true");
            let b12 = new Headers({ [b9.Headers.Location]: a12.toString() });
            return k2(c10, eG.PrimaryRespondsToSyncing, "", b12);
          }
          if ("development" === c10.instanceType && c10.clerkUrl.searchParams.has(b9.QueryParameters.DevBrowser)) return k2(c10, eG.DevBrowserSync, "");
          if ("development" === c10.instanceType && !d11) return k2(c10, eG.DevBrowserMissing, "");
          if (!a11 && !b11) return eI({ tokenType: ce.SessionToken, authenticateContext: c10, reason: eG.SessionTokenAndUATMissing });
          if (!a11 && b11) return k2(c10, eG.SessionTokenWithoutClientUAT, "");
          if (a11 && !b11) return k2(c10, eG.ClientUATWithoutSessionToken, "");
          let { data: i3, errors: j3 } = bU(c10.sessionTokenInCookie);
          if (j3) return n2(j3[0], "cookie");
          if (i3.payload.iat < c10.clientUat) return k2(c10, eG.SessionTokenIATBeforeClientUAT, "");
          try {
            let { data: a12, errors: b12 } = await eX(c10.sessionTokenInCookie, c10);
            if (b12) throw b12[0];
            let d12 = eH({ tokenType: ce.SessionToken, authenticateContext: c10, sessionClaims: a12, headers: new Headers(), token: c10.sessionTokenInCookie });
            if (!c10.isSatellite && "document" === c10.secFetchDest && c10.isCrossOriginReferrer() && !c10.isKnownClerkReferrer() && 0 === c10.handshakeRedirectLoopCounter) return k2(c10, eG.PrimaryDomainCrossOriginSync, "Cross-origin request from satellite domain requires handshake");
            let e12 = d12.toAuth();
            if (e12.userId) {
              let a13 = function(a14, b13) {
                ...
                let e13 = k2(a14, eG.ActiveOrganizationMismatch, "");
        ...
        async function n2(b11, d11) {
          let e11;
          if (!(b11 instanceof bF)) return eI({ tokenType: ce.SessionToken, authenticateContext: c10, reason: eG.UnexpectedError });
          if (b11.reason === bD.TokenExpired && c10.refreshTokenInCookie && "GET" === a10.method) {
            let { data: a11, error: b12 } = await j2(c10);
            if (a11) return eH({ tokenType: ce.SessionToken, authenticateContext: c10, sessionClaims: a11.jwtPayload, headers: a11.headers, token: a11.sessionToken });
            e11 = b12?.cause?.reason ? b12.cause.reason : e6.UnexpectedSDKError;
          } else e11 = "GET" !== a10.method ? e6.NonEligibleNonGet : c10.refreshTokenInCookie ? null : e6.NonEligibleNoCookie;
          return (b11.tokenCarrier = d11, [bD.TokenExpired, bD.TokenNotActiveYet, bD.TokenIatInTheFuture].includes(b11.reason)) ? k2(c10, fa({ tokenError: b11.reason, refreshError: e11 }), b11.getFullMessage()) : eI({ tokenType: ce.SessionToken, authenticateContext: c10, reason: b11.reason, message: b11.getFullMessage() });
        }
        function o2(a11, b11) {
          return b11 instanceof bH ? eI({ tokenType: a11, authenticateContext: c10, reason: b11.code, message: b11.getFullMessage() }) : eI({ tokenType: a11, authenticateContext: c10, reason: eG.UnexpectedError });
        }
        async function p2() {
          let { tokenInHeader: a11 } = c10;
          if (!a11) return n2(Error("Missing token in header"), "header");
          if (!ex(a11)) return eI({ tokenType: d10, authenticateContext: c10, reason: eG.TokenTypeMismatch, message: "" });
          let b11 = e7(ey(a11), d10, c10);
          if (b11) return b11;
          let { data: e11, tokenType: f11, errors: g11 } = await e1(a11, c10);
          return g11 ? o2(f11, g11[0]) : eH({ tokenType: f11, authenticateContext: c10, machineData: e11, token: a11 });
        }
        async function q2() {
          let { tokenInHeader: a11 } = c10;
          if (!a11) return n2(Error("Missing token in header"), "header");
          if (ex(a11)) {
            let b12 = e7(ey(a11), d10, c10);
            if (b12) return b12;
            let { data: e12, tokenType: f11, errors: g11 } = await e1(a11, c10);
            return g11 ? o2(f11, g11[0]) : eH({ tokenType: f11, authenticateContext: c10, machineData: e12, token: a11 });
          }
          let { data: b11, errors: e11 } = await eX(a11, c10);
          return e11 ? n2(e11[0], "header") : eH({ tokenType: ce.SessionToken, authenticateContext: c10, sessionClaims: b11, token: a11 });
        }
        return Array.isArray(d10) && !function(a11, b11) {
          let c11 = null, { tokenInHeader: d11 } = b11;
          return d11 && (c11 = ex(d11) ? ey(d11) : ce.SessionToken), ez(c11 ?? ce.SessionToken, a11);
        }(d10, c10) ? function() {
          let a11 = eD();
          return eJ({ status: eF.SignedOut, reason: eG.TokenTypeMismatch, message: "", proxyUrl: "", publishableKey: "", isSatellite: false, domain: "", signInUrl: "", signUpUrl: "", afterSignInUrl: "", afterSignUpUrl: "", isSignedIn: false, isAuthenticated: false, tokenType: null, toAuth: () => a11, headers: new Headers(), token: null });
        }() : c10.tokenInHeader ? "any" === d10 ? q2() : d10 === ce.SessionToken ? l2() : p2() : d10 === ce.OAuthToken || d10 === ce.ApiKey || d10 === ce.M2MToken ? eI({ tokenType: d10, authenticateContext: c10, reason: "No token in header" }) : m2();
      }, e9 = (a10) => {
      ...
      }, fa = ({ tokenError: a10, refreshError: b10 }) => {
        switch (a10) {
          case bD.TokenExpired:
            return `${eG.SessionTokenExpired}-refresh-${b10}`;
          case bD.TokenNotActiveYet:
            return eG.SessionTokenNBF;
          case bD.TokenIatInTheFuture:
            return eG.SessionTokenIatInTheFuture;
          default:
            return eG.UnexpectedError;
        }
      }, fb = { secretKey: "", machineSecretKey: "", jwtKey: "", apiUrl: void 0, apiVersion: void 0, proxyUrl: "", publishableKey: "", isSatellite: false, domain: "", audience: "" };
      c(378), c(944), c(918).s;
      var fc = c(66);
      let fd = "" + fc.s8 + ";404";
      fc.s8, fc.s8, c(515).X, c(449), "undefined" == typeof URLPattern || URLPattern, c(107), c(979), c(770), c(823), c(918);
      let { env: fe, stdout: ff } = (null == (f4 = globalThis) ? void 0 : f4.process) ?? {}, fg = fe && !fe.NO_COLOR && (fe.FORCE_COLOR || (null == ff ? void 0 : ff.isTTY) && !fe.CI && "dumb" !== fe.TERM), fh = (a10, b10, c10, d10) => {
        let e10 = a10.substring(0, d10) + c10, f10 = a10.substring(d10 + b10.length), g10 = f10.indexOf(b10);
        return ~g10 ? e10 + fh(f10, b10, c10, g10) : e10 + f10;
      }, fi = (a10, b10, c10 = a10) => fg ? (d10) => {
        let e10 = "" + d10, f10 = e10.indexOf(b10, a10.length);
        return ~f10 ? a10 + fh(e10, b10, c10, f10) + b10 : a10 + e10 + b10;
      } : String, fj = fi("\x1B[1m", "\x1B[22m", "\x1B[22m\x1B[1m");
      fi("\x1B[2m", "\x1B[22m", "\x1B[22m\x1B[2m"), fi("\x1B[3m", "\x1B[23m"), fi("\x1B[4m", "\x1B[24m"), fi("\x1B[7m", "\x1B[27m"), fi("\x1B[8m", "\x1B[28m"), fi("\x1B[9m", "\x1B[29m"), fi("\x1B[30m", "\x1B[39m");
      let fk = fi("\x1B[31m", "\x1B[39m"), fl = fi("\x1B[32m", "\x1B[39m"), fm = fi("\x1B[33m", "\x1B[39m");
      fi("\x1B[34m", "\x1B[39m");
      let fn = fi("\x1B[35m", "\x1B[39m");
      fi("\x1B[38;2;173;127;168m", "\x1B[39m"), fi("\x1B[36m", "\x1B[39m");
      let fo = fi("\x1B[37m", "\x1B[39m");
      fi("\x1B[90m", "\x1B[39m"), fi("\x1B[40m", "\x1B[49m"), fi("\x1B[41m", "\x1B[49m"), fi("\x1B[42m", "\x1B[49m"), fi("\x1B[43m", "\x1B[49m"), fi("\x1B[44m", "\x1B[49m"), fi("\x1B[45m", "\x1B[49m"), fi("\x1B[46m", "\x1B[49m"), fi("\x1B[47m", "\x1B[49m"), fo(fj("\u25CB")), fk(fj("\u2A2F")), fm(fj("\u26A0")), fo(fj(" ")), fl(fj("\u2713")), fn(fj("\xBB")), new aK(1e4, (a10) => a10.length), /* @__PURE__ */ new WeakMap();
      let fp = { Headers: { NextRewrite: "x-middleware-rewrite", NextResume: "x-middleware-next", NextRedirect: "Location", NextUrl: "next-url", NextAction: "next-action", NextjsData: "x-nextjs-data" } }, fq = (a10, b10, c10) => (a10.headers.set(b10, c10), a10), fr = "__clerk_db_jwt", fs = { rE: "15.5.12" }, ft = (a10) => {
      ...
      }, fu = (a10) => (Array.isArray(a10) ? a10 : [a10]).map((a11) => "string" == typeof a11 ? ft(a11) : JSON.stringify(Object.fromEntries(Object.entries(a11).map(([a12, b10]) => [a12, ft(b10)])), null, 2)).join(", "), fv = (a10) => {
        let b10 = (c10) => {
          if (!c10) return c10;
      ...
      let fx = process.env.CLERK_API_VERSION || "v1", fy = process.env.CLERK_SECRET_KEY || "", fz = process.env.CLERK_MACHINE_SECRET_KEY || "", fA = process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY || "", fB = process.env.CLERK_ENCRYPTION_KEY || "", fC = process.env.CLERK_API_URL || ((a10) => {
        let b10 = bk(a10)?.frontendApi;
        return b10?.startsWith("clerk.") && bb.some((a11) => b10?.endsWith(a11)) ? bg : be.some((a11) => b10?.endsWith(a11)) ? "https://api.lclclerk.com" : bf.some((a11) => b10?.endsWith(a11)) ? "https://api.clerkstage.dev" : bg;
      })(fA), fD = process.env.NEXT_PUBLIC_CLERK_DOMAIN || "", fE = process.env.NEXT_PUBLIC_CLERK_PROXY_URL || "", fF = fw(process.env.NEXT_PUBLIC_CLERK_IS_SATELLITE) || false, fG = process.env.NEXT_PUBLIC_CLERK_SIGN_IN_URL || "", fH = process.env.NEXT_PUBLIC_CLERK_SIGN_UP_URL || "", fI = fw(process.env.NEXT_PUBLIC_CLERK_TELEMETRY_DISABLED), fJ = fw(process.env.NEXT_PUBLIC_CLERK_TELEMETRY_DEBUG), fK = fw(process.env.NEXT_PUBLIC_CLERK_KEYLESS_DISABLED) || false, fL = !(fs.rE.startsWith("13.") || fs.rE.startsWith("14.0")) && false, fM = (a10) => {
...
Original error: ${a10}`);
      ...
      let fR = /* @__PURE__ */ new Set(["error", "warn", "info", "debug", "trace"]), fS = { samplingRate: 1, maxBufferSize: 5, endpoint: "https://clerk-telemetry.com" };
      var fT = class {
        #g;
        #h;
        #i = {};
        ...
        #k = null;
        constructor(a10) {
          this.#g = { maxBufferSize: a10.maxBufferSize ?? fS.maxBufferSize, samplingRate: a10.samplingRate ?? fS.samplingRate, perEventSampling: a10.perEventSampling ?? true, disabled: a10.disabled ?? false, debug: a10.debug ?? false, endpoint: fS.endpoint }, a10.clerkVersion || "undefined" != typeof window ? this.#i.clerkVersion = a10.clerkVersion ?? "" : this.#i.clerkVersion = "", this.#i.sdk = a10.sdk, this.#i.sdkVersion = a10.sdkVersion, this.#i.publishableKey = a10.publishableKey ?? "";
          let b10 = bk(a10.publishableKey);
          b10 && (this.#i.instanceType = b10.instanceType), a10.secretKey && (this.#i.secretKey = a10.secretKey.substring(0, 16)), this.#h = new fO(fP.isSupported() ? new fP() : new fQ());
        }
        get isEnabled() {
          return !("development" !== this.#i.instanceType || this.#g.disabled || "undefined" != typeof process && process.env && fw(process.env.CLERK_TELEMETRY_DISABLED) || "undefined" != typeof window && window?.navigator?.webdriver);
        }
        get isDebug() {
          return this.#g.debug || "undefined" != typeof process && process.env && fw(process.env.CLERK_TELEMETRY_DEBUG);
        }
        record(a10) {
          try {
        ...
        recordLog(a10) {
          try {
            ...
            let b10 = "string" == typeof a10?.level && fR.has(a10.level), c10 = "string" == typeof a10?.message && a10.message.trim().length > 0, d10 = null, e10 = a10?.timestamp;
      ...
      let fU = { secretKey: fy, publishableKey: fA, apiUrl: fC, apiVersion: fx, userAgent: "@clerk/nextjs@6.36.5", proxyUrl: fE, domain: fD, isSatellite: fF, machineSecretKey: fz, sdkMetadata: { name: "@clerk/nextjs", version: "6.36.5", environment: "production" }, telemetry: { disabled: fI, debug: fJ } }, fV = (a10) => function(a11) {
        let b10 = { ...a11 }, c10 = ep(b10), d10 = function(a12) {
          let b11 = cc(fb, a12.options), c11 = a12.apiClient;
          return { authenticateRequest: (a13, d11 = {}) => {
            let { apiUrl: e11, apiVersion: f10 } = b11, g10 = cc(b11, d11);
            return e8(a13, { ...d11, ...g10, apiUrl: e11, apiVersion: f10, apiClient: c11 });
          }, debugRequestState: e9 };
        }({ options: b10, apiClient: c10 }), e10 = new fT({ publishableKey: b10.publishableKey, secretKey: b10.secretKey, samplingRate: 0.1, ...b10.sdkMetadata ? { sdk: b10.sdkMetadata.name, sdkVersion: b10.sdkMetadata.version } : {}, ...b10.telemetry || {} });
      ...
      var fX = c(521);
      let fY = /* @__PURE__ */ new Map(), fZ = new fX.AsyncLocalStorage(), f$ = /* @__PURE__ */ new Set(), f_ = { warnOnce: (a10) => {
        f$.has(a10) || (f$.add(a10), console.warn(a10));
      } };
      function f0(a10) {
        return /^http(s)?:\/\//.test(a10 || "");
      }
      function f1(a10, b10, c10) {
        return "function" == typeof a10 ? a10(b10) : void 0 !== a10 ? a10 : void 0 !== c10 ? c10 : void 0;
      }
      var f2, f3, f4, f5, f6, f7, f8, f9, ga, gb, gc = Object.defineProperty, gd = (null == (f5 = "undefined" != typeof globalThis ? globalThis : void 0) ? void 0 : f5.crypto) || (null == (f6 = void 0 !== c.g ? c.g : void 0) ? void 0 : f6.crypto) || (null == (f7 = "undefined" != typeof window ? window : void 0) ? void 0 : f7.crypto) || (null == (f8 = "undefined" != typeof self ? self : void 0) ? void 0 : f8.crypto) || (null == (ga = null == (f9 = "undefined" != typeof frames ? frames : void 0) ? void 0 : f9[0]) ? void 0 : ga.crypto);
      gb = gd ? (a10) => {
        let b10 = [];
        for (let c10 = 0; c10 < a10; c10 += 4) b10.push(gd.getRandomValues(new Uint32Array(1))[0]);
        return new gf(b10, a10);
      } : (a10) => {
        let b10 = [], c10 = (a11) => {
      ...
      ((a10, b10, c10) => ((a11, b11, c11) => b11 in a11 ? gc(a11, b11, { enumerable: true, configurable: true, writable: true, value: c11 }) : a11[b11] = c11)(a10, "symbol" != typeof b10 ? b10 + "" : b10, c10))(gf, "random", gb);
      var gg = { stringify(a10) {
        ...
        return new gf(c10, b10);
      } }, gi = { stringify(a10) {
        try {
          return decodeURIComponent(escape(gh.stringify(a10)));
        } catch {
          throw Error("Malformed UTF-8 data");
        }
      }, parse: (a10) => gh.parse(unescape(encodeURIComponent(a10))) }, gj = class extends ge {
        constructor() {
          super(), this._minBufferSize = 0;
        }
        reset() {
          this._data = new gf(), this._nDataBytes = 0;
        }
        _append(a10) {
          let b10 = a10;
          "string" == typeof b10 && (b10 = gi.parse(b10)), this._data.concat(b10), this._nDataBytes += b10.sigBytes;
        }
        _process(a10) {
        ...
        constructor(a10) {
          super(), this.blockSize = 16, this.cfg = Object.assign(new ge(), a10), this.reset();
        }
        static _createHelper(a10) {
          return (b10, c10) => new a10(c10).finalize(b10);
        }
        static _createHmacHelper(a10) {
          return (b10, c10) => new gl(a10, c10).finalize(b10);
        }
        reset() {
        ...
        constructor(a10, b10) {
          ...
          this._hasher = c10;
          let d10 = b10;
          "string" == typeof d10 && (d10 = gi.parse(d10));
        ...
        return gf.create(h2, i2);
      }, _map: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=" }, gn = [];
      for (let a10 = 0; a10 < 64; a10 += 1) gn[a10] = 4294967296 * Math.abs(Math.sin(a10 + 1)) | 0;
      var go = (a10, b10, c10, d10, e10, f10, g10) => {
        ...
        return (h2 << f10 | h2 >>> 32 - f10) + b10;
      }, gr = (a10, b10, c10, d10, e10, f10, g10) => {
        let h2 = a10 + (c10 ^ (b10 | ~d10)) + e10 + g10;
        return (h2 << f10 | h2 >>> 32 - f10) + b10;
      }, gs = class extends gk {
        _doReset() {
          this._hash = new gf([1732584193, 4023233417, 2562383102, 271733878]);
        }
        _doProcessBlock(a10, b10) {
          ...
          t2 = go(t2, u2, v2, w2, d10, 7, gn[0]), w2 = go(w2, t2, u2, v2, e10, 12, gn[1]), v2 = go(v2, w2, t2, u2, f10, 17, gn[2]), u2 = go(u2, v2, w2, t2, g10, 22, gn[3]), t2 = go(t2, u2, v2, w2, h2, 7, gn[4]), w2 = go(w2, t2, u2, v2, i2, 12, gn[5]), v2 = go(v2, w2, t2, u2, j2, 17, gn[6]), u2 = go(u2, v2, w2, t2, k2, 22, gn[7]), t2 = go(t2, u2, v2, w2, l2, 7, gn[8]), w2 = go(w2, t2, u2, v2, m2, 12, gn[9]), v2 = go(v2, w2, t2, u2, n2, 17, gn[10]), u2 = go(u2, v2, w2, t2, o2, 22, gn[11]), t2 = go(t2, u2, v2, w2, p2, 7, gn[12]), w2 = go(w2, t2, u2, v2, q2, 12, gn[13]), v2 = go(v2, w2, t2, u2, r2, 17, gn[14]), u2 = go(u2, v2, w2, t2, s2, 22, gn[15]), t2 = gp(t2, u2, v2, w2, e10, 5, gn[16]), w2 = gp(w2, t2, u2, v2, j2, 9, gn[17]), v2 = gp(v2, w2, t2, u2, o2, 14, gn[18]), u2 = gp(u2, v2, w2, t2, d10, 20, gn[19]), t2 = gp(t2, u2, v2, w2, i2, 5, gn[20]), w2 = gp(w2, t2, u2, v2, n2, 9, gn[21]), v2 = gp(v2, w2, t2, u2, s2, 14, gn[22]), u2 = gp(u2, v2, w2, t2, h2, 20, gn[23]), t2 = gp(t2, u2, v2, w2, m2, 5, gn[24]), w2 = gp(w2, t2, u2, v2, r2, 9, gn[25]), v2 = gp(v2, w2, t2, u2, g10, 14, gn[26]), u2 = gp(u2, v2, w2, t2, l2, 20, gn[27]), t2 = gp(t2, u2, v2, w2, q2, 5, gn[28]), w2 = gp(w2, t2, u2, v2, f10, 9, gn[29]), v2 = gp(v2, w2, t2, u2, k2, 14, gn[30]), u2 = gp(u2, v2, w2, t2, p2, 20, gn[31]), t2 = gq(t2, u2, v2, w2, i2, 4, gn[32]), w2 = gq(w2, t2, u2, v2, l2, 11, gn[33]), v2 = gq(v2, w2, t2, u2, o2, 16, gn[34]), u2 = gq(u2, v2, w2, t2, r2, 23, gn[35]), t2 = gq(t2, u2, v2, w2, e10, 4, gn[36]), w2 = gq(w2, t2, u2, v2, h2, 11, gn[37]), v2 = gq(v2, w2, t2, u2, k2, 16, gn[38]), u2 = gq(u2, v2, w2, t2, n2, 23, gn[39]), t2 = gq(t2, u2, v2, w2, q2, 4, gn[40]), w2 = gq(w2, t2, u2, v2, d10, 11, gn[41]), v2 = gq(v2, w2, t2, u2, g10, 16, gn[42]), u2 = gq(u2, v2, w2, t2, j2, 23, gn[43]), t2 = gq(t2, u2, v2, w2, m2, 4, gn[44]), w2 = gq(w2, t2, u2, v2, p2, 11, gn[45]), v2 = gq(v2, w2, t2, u2, s2, 16, gn[46]), u2 = gq(u2, v2, w2, t2, f10, 23, gn[47]), t2 = gr(t2, u2, v2, w2, d10, 6, gn[48]), w2 = gr(w2, t2, u2, v2, k2, 10, gn[49]), v2 = gr(v2, w2, t2, u2, r2, 15, gn[50]), u2 = gr(u2, v2, w2, t2, i2, 21, gn[51]), t2 = gr(t2, u2, v2, w2, p2, 6, gn[52]), w2 = gr(w2, t2, u2, v2, g10, 10, gn[53]), v2 = gr(v2, w2, t2, u2, n2, 15, gn[54]), u2 = gr(u2, v2, w2, t2, e10, 21, gn[55]), t2 = gr(t2, u2, v2, w2, l2, 6, gn[56]), w2 = gr(w2, t2, u2, v2, s2, 10, gn[57]), v2 = gr(v2, w2, t2, u2, j2, 15, gn[58]), u2 = gr(u2, v2, w2, t2, q2, 21, gn[59]), t2 = gr(t2, u2, v2, w2, h2, 6, gn[60]), w2 = gr(w2, t2, u2, v2, o2, 10, gn[61]), v2 = gr(v2, w2, t2, u2, f10, 15, gn[62]), u2 = gr(u2, v2, w2, t2, m2, 21, gn[63]), c10[0] = c10[0] + t2 | 0, c10[1] = c10[1] + u2 | 0, c10[2] = c10[2] + v2 | 0, c10[3] = c10[3] + w2 | 0;
        }
        _doFinalize() {
      ...
      gk._createHelper(gs), gk._createHmacHelper(gs);
      var gt = class extends ge {
        constructor(a10) {
          super(), this.cfg = Object.assign(new ge(), { keySize: 4, hasher: gs, iterations: 1 }, a10);
        }
        compute(a10, b10) {
          let c10, { cfg: d10 } = this, e10 = d10.hasher.create(), f10 = gf.create(), g10 = f10.words, { keySize: h2, iterations: i2 } = d10;
          for (; g10.length < h2; ) {
        ...
        constructor(a10, b10, c10) {
          super(), this.cfg = Object.assign(new ge(), c10), this._xformMode = a10, this._key = b10, this.reset();
        }
        ...
        static _createHelper(a10) {
          let b10 = (a11) => "string" == typeof a11 ? gC : gB;
      ...
      gu._ENC_XFORM_MODE = 1, gu._DEC_XFORM_MODE = 2, gu.keySize = 4, gu.ivSize = 4;
      var gv = class extends ge {
        constructor(a10, b10) {
      ...
      var gy = { pad(a10, b10) {
        ...
        constructor(a10, b10, c10) {
          super(a10, b10, Object.assign({ mode: gx, padding: gy }, c10)), this.blockSize = 4;
        }
        reset() {
          let a10;
        ...
        static encrypt(a10, b10, c10, d10) {
          let e10 = Object.assign(new ge(), this.cfg, d10), f10 = a10.createEncryptor(c10, e10), g10 = f10.finalize(b10), h2 = f10.cfg;
          return gA.create({ ciphertext: g10, key: c10, iv: h2.iv, algorithm: a10, mode: h2.mode, padding: h2.padding, blockSize: f10.blockSize, formatter: e10.format });
        }
        static decrypt(a10, b10, c10, d10) {
          let e10 = b10, f10 = Object.assign(new ge(), this.cfg, d10);
      ...
      gB.cfg = Object.assign(new ge(), { format: { stringify(a10) {
        let { ciphertext: b10, salt: c10 } = a10;
        return (c10 ? gf.create([1398893684, 1701076831]).concat(c10).concat(b10) : b10).toString(gm);
      }, parse(a10) {
        let b10, c10 = gm.parse(a10), d10 = c10.words;
        return 1398893684 === d10[0] && 1701076831 === d10[1] && (b10 = gf.create(d10.slice(2, 4)), d10.splice(0, 4), c10.sigBytes -= 16), gA.create({ ciphertext: c10, salt: b10 });
      } } });
      var gC = class extends gB {
        static encrypt(a10, b10, c10, d10) {
          let e10 = Object.assign(new ge(), this.cfg, d10), f10 = e10.kdf.execute(c10, a10.keySize, a10.ivSize, e10.salt, e10.hasher);
          e10.iv = f10.iv;
          let g10 = gB.encrypt.call(this, a10, b10, f10.key, e10);
        ...
        static decrypt(a10, b10, c10, d10) {
          ...
          return f10.iv = g10.iv, gB.decrypt.call(this, a10, e10, g10.key, f10);
        }
      };
      gC.cfg = Object.assign(gB.cfg, { kdf: { execute(a10, b10, c10, d10, e10) {
        let f10, g10 = d10;
        g10 || (g10 = gf.random(8)), f10 = e10 ? gt.create({ keySize: b10 + c10, hasher: e10 }).compute(a10, g10) : gt.create({ keySize: b10 + c10 }).compute(a10, g10);
        let h2 = gf.create(f10.words.slice(b10), 4 * c10);
        return f10.sigBytes = 4 * b10, gA.create({ key: f10, iv: h2, salt: g10 });
      } } });
      var gD = [], gE = [], gF = [], gG = [], gH = [], gI = [], gJ = [], gK = [], gL = [], gM = [], gN = [];
      for (let a10 = 0; a10 < 256; a10 += 1) a10 < 128 ? gN[a10] = a10 << 1 : gN[a10] = a10 << 1 ^ 283;
      var gO = 0, gP = 0;
      for (let a10 = 0; a10 < 256; a10 += 1) {
        let a11 = gP ^ gP << 1 ^ gP << 2 ^ gP << 3 ^ gP << 4;
        a11 = a11 >>> 8 ^ 255 & a11 ^ 99, gD[gO] = a11, gE[a11] = gO;
        let b10 = gN[gO], c10 = gN[b10], d10 = gN[c10], e10 = 257 * gN[a11] ^ 16843008 * a11;
        gF[gO] = e10 << 24 | e10 >>> 8, gG[gO] = e10 << 16 | e10 >>> 16, gH[gO] = e10 << 8 | e10 >>> 24, gI[gO] = e10, e10 = 16843009 * d10 ^ 65537 * c10 ^ 257 * b10 ^ 16843008 * gO, gJ[a11] = e10 << 24 | e10 >>> 8, gK[a11] = e10 << 16 | e10 >>> 16, gL[a11] = e10 << 8 | e10 >>> 24, gM[a11] = e10, gO ? (gO = b10 ^ gN[gN[gN[d10 ^ b10]]], gP ^= gN[gN[gP]]) : gO = gP = 1;
      }
      var gQ = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], gR = class extends gz {
        _doReset() {
          let a10;
          ...
          for (let b11 = 0; b11 < e10; b11 += 1) b11 < d10 ? f10[b11] = c10[b11] : (a10 = f10[b11 - 1], b11 % d10 ? d10 > 6 && b11 % d10 == 4 && (a10 = gD[a10 >>> 24] << 24 | gD[a10 >>> 16 & 255] << 16 | gD[a10 >>> 8 & 255] << 8 | gD[255 & a10]) : a10 = (gD[(a10 = a10 << 8 | a10 >>> 24) >>> 24] << 24 | gD[a10 >>> 16 & 255] << 16 | gD[a10 >>> 8 & 255] << 8 | gD[255 & a10]) ^ gQ[b11 / d10 | 0] << 24, f10[b11] = f10[b11 - d10] ^ a10);
          this._invKeySchedule = [];
          let g10 = this._invKeySchedule;
          for (let b11 = 0; b11 < e10; b11 += 1) {
            let c11 = e10 - b11;
            a10 = b11 % 4 ? f10[c11] : f10[c11 - 4], b11 < 4 || c11 <= 4 ? g10[b11] = a10 : g10[b11] = gJ[gD[a10 >>> 24]] ^ gK[gD[a10 >>> 16 & 255]] ^ gL[gD[a10 >>> 8 & 255]] ^ gM[gD[255 & a10]];
          }
        }
        encryptBlock(a10, b10) {
          this._doCryptBlock(a10, b10, this._keySchedule, gF, gG, gH, gI, gD);
        }
        decryptBlock(a10, b10) {
          let c10 = a10[b10 + 1];
          a10[b10 + 1] = a10[b10 + 3], a10[b10 + 3] = c10, this._doCryptBlock(a10, b10, this._invKeySchedule, gJ, gK, gL, gM, gE), c10 = a10[b10 + 1], a10[b10 + 1] = a10[b10 + 3], a10[b10 + 3] = c10;
        }
      ...
      gR.keySize = 8;
      var gS = gz._createHelper(gR), gT = [], gU = class extends gk {
        _doReset() {
          this._hash = new gf([1732584193, 4023233417, 2562383102, 271733878, 3285377520]);
        }
        _doProcessBlock(a10, b10) {
          let c10 = this._hash.words, d10 = c10[0], e10 = c10[1], f10 = c10[2], g10 = c10[3], h2 = c10[4];
          for (let c11 = 0; c11 < 80; c11 += 1) {
            if (c11 < 16) gT[c11] = 0 | a10[b10 + c11];
            else {
              let a11 = gT[c11 - 3] ^ gT[c11 - 8] ^ gT[c11 - 14] ^ gT[c11 - 16];
              gT[c11] = a11 << 1 | a11 >>> 31;
            }
            let i2 = (d10 << 5 | d10 >>> 27) + h2 + gT[c11];
      ...
      }, gV = (gk._createHelper(gU), gk._createHmacHelper(gU));
      let gW = `
...
2) With environment variables e.g.
   ...
   NEXT_PUBLIC_CLERK_IS_SATELLITE='true'`, gY = `Clerk: Unable to decrypt request data.

Refresh the page if your .env file was just updated. If the issue persists, ensure the encryption key is valid and properly set.

For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)`, gZ = bz({ packageName: "@clerk/nextjs" }), g$ = "x-middleware-override-headers", g_ = "x-middleware-request", g0 = (a10, b10, c10) => {
        a10.headers.get(g$) || (a10.headers.set(g$, [...b10.headers.keys()]), b10.headers.forEach((b11, c11) => {
          a10.headers.set(`${g_}-${c11}`, b11);
        })), Object.entries(c10).forEach(([b11, c11]) => {
          a10.headers.set(g$, `${a10.headers.get(g$)},${b11}`), a10.headers.set(`${g_}-${b11}`, c11);
        });
      }, g1 = (a10) => R.redirect(a10, { headers: { [b9.Headers.ClerkRedirectTo]: "true" } }), g2 = "clerk_keyless_dummy_key";
      function g3() {
        if (a8()) throw Error("Clerk: Unable to decrypt request data, this usually means the encryption key is invalid. Ensure the encryption key is properly set. For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)");
        throw Error(gY);
      }
      function g4(a10, b10) {
        return JSON.parse(gS.decrypt(a10, b10).toString(gi));
      }
      let g5 = async () => {
        var a10, b10;
        let c10;
        try {
          let a11 = await fN(), b11 = fW(a11, b9.Headers.ClerkRequestData);
          c10 = function(a12) {
            if (!a12) return {};
            let b12 = a8() ? fB || fy : fB || fy || g2;
            try {
              return g4(a12, b12);
            } catch {
              if (fL) try {
          ...
          if (a11 && fM(a11)) throw a11;
        }
        let d10 = null != (b10 = null == (a10 = fZ.getStore()) ? void 0 : a10.get("requestData")) ? b10 : c10;
        return (null == d10 ? void 0 : d10.secretKey) || (null == d10 ? void 0 : d10.publishableKey) ? fV(d10) : fV({});
      };
      class g6 {
      ...
      async function g9() {
        ...
        if (!a10) return `${g7}0`;
        let b10 = a10.split("/").filter(Boolean).slice(-3).reverse().join("/"), c10 = await g8(b10);
        return `${g7}${c10}`;
      }
      async function ha(a10) {
        let b10;
        if (!fL) return;
        let c10 = await g9();
        try {
      ...
      let hb = { REDIRECT_TO_URL: "CLERK_PROTECT_REDIRECT_TO_URL", REDIRECT_TO_SIGN_IN: "CLERK_PROTECT_REDIRECT_TO_SIGN_IN", REDIRECT_TO_SIGN_UP: "CLERK_PROTECT_REDIRECT_TO_SIGN_UP" }, hc = { NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 }, hd = new Set(Object.values(hc)), he = "NEXT_HTTP_ERROR_FALLBACK";
      function hf(a10) {
        if (!function(a11) {
          if ("object" != typeof a11 || null === a11 || !("digest" in a11) || "string" != typeof a11.digest) return false;
          let [b11, c10] = a11.digest.split(";");
          return b11 === he && hd.has(Number(c10));
        }(a10)) return;
        let [, b10] = a10.digest.split(";");
        return Number(b10);
      }
      let hg = "NEXT_REDIRECT";
      function hh(a10, b10, c10 = "replace", d10 = 307) {
        let e10 = Error(hg);
        throw e10.digest = `${hg};${c10};${a10};${d10};`, e10.clerk_digest = hb.REDIRECT_TO_URL, Object.assign(e10, b10), e10;
      }
      function hi(a10, b10) {
      ...
      function hj(a10) {
        ...
        return c10 === hg && ("replace" === d10 || "push" === d10) && "string" == typeof e10 && !isNaN(f10) && 307 === f10;
      }
      function hk() {
        let a10 = Error(he);
        throw a10.digest = `${he};${hc.UNAUTHORIZED}`, a10;
      }
      let hl = (a10) => !!a10.headers.get(fp.Headers.NextUrl) && !((a11) => {
        var b10, c10;
        return !!a11.headers.get(fp.Headers.NextUrl) && ((null == (b10 = a11.headers.get(b9.Headers.Accept)) ? void 0 : b10.includes("text/x-component")) || (null == (c10 = a11.headers.get(b9.Headers.ContentType)) ? void 0 : c10.includes("multipart/form-data")) || !!a11.headers.get(fp.Headers.NextAction));
      })(a10) || hm(), hm = () => {
        ...
        return !!(c10 || b10);
      }, hn = (a10) => !!a10.headers.get(fp.Headers.NextjsData), ho = ["/setup", "/admin/system/advanced", "/admin/system/security"];
      new TextEncoder();
      let hp = new TextDecoder();
      ...
      let ht = process.env.JWT_SECRET || process.env.CLERK_SECRET_KEY || "lizardware-insecure-dev-secret";
      async function hu() {
        let a10 = null;
        try {
          let { getCloudflareContext: b10 } = await Promise.resolve().then(c.bind(c, 920)), d10 = await b10({ async: true });
          d10 && d10.env && (a10 = { env: d10.env, cf: d10.cf, ctx: d10.ctx });
        } catch (a11) {
          console.warn("[Cloudflare Lib] Official getCloudflareContext failed, trying manual fallback", a11);
        }
        if (!a10 || !a10.env) {
          let b10 = globalThis.__NEXT_CLOUDFLARE_CONTEXT__;
          b10 && b10.env ? a10 = { env: b10.env, cf: b10.cf, ctx: b10.ctx } : "undefined" != typeof process && process.env && (a10 = { env: process.env });
        }
        return a10;
      }
      async function hv() {
        let a10 = await hu();
        return a10?.env?.DB || null;
      }
      async function hw() {
        let a10 = await hu();
        return a10?.env?.CONFIG_KV || null;
      }
      new TextEncoder().encode(ht);
      let hx = { async get(a10) {
        let b10 = await hw();
        if (!b10) return null;
        try {
          return await b10.get(a10, "json");
        } catch (b11) {
          return console.warn(`[KV Cache] GET error for key "${a10}":`, b11), null;
        }
      }, async set(a10, b10, c10) {
        let d10 = await hw();
        if (d10) try {
          await d10.put(a10, JSON.stringify(b10), { expirationTtl: c10 });
        } catch (b11) {
          console.error(`[KV Cache] SET error for key "${a10}":`, b11);
        }
      }, async delete(a10) {
        let b10 = await hw();
        if (b10) try {
          await b10.delete(a10);
        } catch (b11) {
          console.error(`[KV Cache] DELETE error for key "${a10}":`, b11);
        }
      }, async list(a10) {
        let b10 = await hw();
        if (!b10) return [];
        try {
          return (await b10.list({ prefix: a10 })).keys.map((a11) => a11.name);
        } catch (b11) {
          return console.error(`[KV Cache] LIST error for prefix "${a10}":`, b11), [];
        }
      } };
      async function hy(a10) {
        let b10 = "settings:site.session_config";
        try {
          let c10 = await hx.get(b10);
          if (c10) return c10;
          let d10 = a10 || await hv();
          if (!d10) return hz();
          let e10 = await d10.prepare(`
            SELECT value_json FROM site_settings WHERE key = 'site.session_config'
        `).first();
          if (e10 && e10.value_json) try {
            let a11 = JSON.parse(e10.value_json), c11 = { admin_session_timeout_seconds: Number(a11.admin_session_timeout_seconds), sensitive_op_freshness_seconds: Number(a11.sensitive_op_freshness_seconds), require_fresh_login_for_sensitive_ops: !!a11.require_fresh_login_for_sensitive_ops };
            return await hx.set(b10, c11), c11;
          } catch (a11) {
            console.warn("[SessionConfig] Failed to parse value_json, using defaults");
          }
          return hz();
        } catch (a11) {
          return console.error("Failed to fetch session config:", a11), hz();
        }
      }
      function hz() {
        return { admin_session_timeout_seconds: 432e3, sensitive_op_freshness_seconds: 3600, require_fresh_login_for_sensitive_ops: true };
      }
      async function hA(a10, b10) {
        let c10 = await hy(b10);
        if (!c10.require_fresh_login_for_sensitive_ops) return true;
        let d10 = function(a11) {
          let b11 = function(a12) {
            try {
              let b12, c11;
              if ("string" != typeof a12) throw new hr("JWTs must use Compact JWS serialization, JWT must be a string");
              let { 1: d11, length: e10 } = a12.split(".");
              if (5 === e10) throw new hr("Only JWTs using Compact JWS serialization can be decoded");
              if (3 !== e10) throw new hr("Invalid JWT");
              if (!d11) throw new hr("JWTs must contain a payload");
              try {
                b12 = function(a13) {
                  if (Uint8Array.fromBase64) return Uint8Array.fromBase64("string" == typeof a13 ? a13 : hp.decode(a13), { alphabet: "base64url" });
                  let b13 = a13;
                  b13 instanceof Uint8Array && (b13 = hp.decode(b13)), b13 = b13.replace(/-/g, "+").replace(/_/g, "/");
                  try {
                    var c12 = b13;
                    if (Uint8Array.fromBase64) return Uint8Array.fromBase64(c12);
                    let a14 = atob(c12), d12 = new Uint8Array(a14.length);
                    for (let b14 = 0; b14 < a14.length; b14++) d12[b14] = a14.charCodeAt(b14);
                    return d12;
                  } catch {
                ...
                throw new hr("Failed to base64url decode the payload");
              }
              try {
                c11 = JSON.parse(hp.decode(b12));
              } catch {
                throw new hr("Failed to parse the decoded payload as JSON");
              }
              if (!function(a13) {
                if ("object" != typeof a13 || null === a13 || "[object Object]" !== Object.prototype.toString.call(a13)) return false;
                if (null === Object.getPrototypeOf(a13)) return true;
                let b13 = a13;
                for (; null !== Object.getPrototypeOf(b13); ) b13 = Object.getPrototypeOf(b13);
                return Object.getPrototypeOf(a13) === b13;
              }(c11)) throw new hr("Invalid JWT Claims Set");
              return c11;
            } catch (a13) {
              return null;
            }
          }(a11);
          return b11?.iat ? Math.floor(Date.now() / 1e3) - b11.iat : null;
        }(a10);
        return null !== d10 && d10 <= c10.sensitive_op_freshness_seconds;
      }
      let hB = (() => {
        let a10 = process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY, b10 = process.env.CLERK_SECRET_KEY, c10 = (a11) => !!a11 && a11.trim().length > 0 && "undefined" !== a11;
        return c10(a10) && c10(b10);
      })();
      hB ? console.log("\u{1F512} Clerk Authentication: ENABLED") : console.warn("\u26A0\uFE0F Clerk Authentication: DISABLED (Missing or Invalid Environment Variables)");
      let hC = ((a10) => {
...
${b12.message}`);
      ...
      async function hD(a10, b10) {
        let { pathname: c10 } = a10.nextUrl;
        if (["/setup", "/api/admin/check-kv", "/api/admin/check-d1", "/api/admin/check-r2", "/api/admin/setup", "/api/admin/init-database"].some((a11) => c10.startsWith(a11))) {
          let b11 = await hE(a10);
          return b11 || R.next();
        }
        if (c10.startsWith("/admin")) {
          let b11 = a10.env?.DB;
          if (b11) try {
            let c11 = await b11.prepare("SELECT value_json FROM site_settings WHERE key = 'site.setup_completed'").first();
            if (!c11 || "true" !== c11.value_json) return console.log("\u{1F6A7} Setup incomplete, redirecting to wizard"), R.redirect(new URL("/setup", a10.url));
          } catch (b12) {
            return console.log("\u{1F6A7} Database not ready or setup incomplete, redirecting to wizard"), R.redirect(new URL("/setup", a10.url));
          }
        }
        let d10 = await hE(a10);
        if (d10) return d10;
        if (hB) return ((...a11) => {
          let b11, c11, [d11, e10] = [(b11 = a11)[0] instanceof Request ? b11[0] : void 0, b11[0] instanceof Request ? b11[1] : void 0], [f10, g10] = ["function" == typeof (c11 = a11)[0] ? c11[0] : void 0, (2 === c11.length ? c11[1] : "function" == typeof c11[0] ? {} : c11[0]) || {}];
          return fZ.run(fY, () => {
            let a12, b12, c12 = (a12 = "clerkMiddleware", b12 = (a13) => async (b13, c13) => {
              var d12, e11, h3, i3, j2, k2;
              let l2, m2, n2, o2, p2, q2, r2, s2, t2, u2, v2 = "function" == typeof g10 ? await g10(b13) : g10, w2 = await ha((a14) => {
                var c14;
                return null == (c14 = b13.cookies.get(a14)) ? void 0 : c14.value;
              }), x2 = (h3 = v2.publishableKey || fA || (null == w2 ? void 0 : w2.publishableKey), i3 = () => gZ.throwMissingPublishableKeyError(), h3 || i3(), h3), y2 = (j2 = v2.secretKey || fy || (null == w2 ? void 0 : w2.secretKey), k2 = () => gZ.throwMissingSecretKeyError(), j2 || k2(), j2), z2 = { publishableKey: x2, secretKey: y2, signInUrl: v2.signInUrl || fG, signUpUrl: v2.signUpUrl || fH, ...v2 };
              fY.set("requestData", z2);
              let A2 = await g5();
              z2.debug && a13.enable();
              let B2 = eN(b13);
              a13.debug("options", z2), a13.debug("url", () => B2.toJSON());
              let C2 = b13.headers.get(b9.Headers.Authorization);
              C2 && C2.startsWith("Basic ") && a13.debug("Basic Auth detected");
              let D2 = b13.headers.get(b9.Headers.ContentSecurityPolicy);
              D2 && a13.debug("Content-Security-Policy detected", () => ({ value: D2 }));
              let E2 = await A2.authenticateRequest(B2, (l2 = B2, { ...m2 = z2, ...((a14, b14) => {
                let c14, d13 = f1(null == b14 ? void 0 : b14.proxyUrl, a14.clerkUrl, fE);
                c14 = d13 && !f0(d13) ? new URL(d13, a14.clerkUrl).toString() : d13;
                let e12 = f1(b14.isSatellite, new URL(a14.url), fF), f11 = f1(b14.domain, new URL(a14.url), fD), g11 = (null == b14 ? void 0 : b14.signInUrl) || fG;
                if (e12 && !c14 && !f11) throw Error(gW);
                if (e12 && !f0(g11) && bm(b14.secretKey || fy)) throw Error(gX);
                return { proxyUrl: c14, isSatellite: e12, domain: f11, signInUrl: g11 };
              })(l2, m2), acceptsToken: "any" }));
              a13.debug("requestState", () => ({ status: E2.status, headers: JSON.stringify(Object.fromEntries(E2.headers)), reason: E2.reason }));
              let F2 = E2.headers.get(b9.Headers.Location);
              if (F2) {
                let a14 = R.redirect(F2);
                return E2.headers.forEach((b14, c14) => {
                  c14 !== b9.Headers.Location && a14.headers.append(c14, b14);
                }), a14;
              }
              if (E2.status === eF.Handshake) throw Error("Clerk: handshake status without redirect");
              let G2 = E2.toAuth();
              a13.debug("auth", () => ({ auth: G2, debug: G2.debug() }));
              let H2 = (n2 = B2, (a14 = {}) => {
                var b14, c14;
                b14 = n2.clerkUrl.toString(), c14 = a14.returnBackUrl, hh(b14, { clerk_digest: hb.REDIRECT_TO_SIGN_IN, returnBackUrl: hi(b14, c14) });
              }), I2 = (o2 = B2, (a14 = {}) => {
                var b14, c14;
                b14 = o2.clerkUrl.toString(), c14 = a14.returnBackUrl, hh(b14, { clerk_digest: hb.REDIRECT_TO_SIGN_UP, returnBackUrl: hi(b14, c14) });
              }), J2 = await (p2 = B2, q2 = G2, r2 = H2, async (a14, b14) => function(a15) {
                let { redirectToSignIn: b15, authObject: c14, redirect: d13, notFound: e12, request: f11, unauthorized: g11 } = a15;
                return async (...a16) => {
                  var h4, i4, j3, k3, l3, m3, n3, o3;
                  let p3 = ((a17) => {
                    if (a17 && !a17.unauthenticatedUrl && !a17.unauthorizedUrl && !a17.token && (1 !== Object.keys(a17).length || !("token" in a17))) return a17;
                  })(a16[0]), q3 = (null == (h4 = a16[0]) ? void 0 : h4.unauthenticatedUrl) || (null == (i4 = a16[1]) ? void 0 : i4.unauthenticatedUrl), r3 = (null == (j3 = a16[0]) ? void 0 : j3.unauthorizedUrl) || (null == (k3 = a16[1]) ? void 0 : k3.unauthorizedUrl), s3 = (null == (l3 = a16[0]) ? void 0 : l3.token) || (null == (m3 = a16[1]) ? void 0 : m3.token) || ce.SessionToken, t3 = () => c14.tokenType !== ce.SessionToken ? g11() : r3 ? d13(r3) : e12();
                  if (!ez(c14.tokenType, s3)) return t3();
                  if (c14.tokenType !== ce.SessionToken) return c14.isAuthenticated ? c14 : t3();
                  if ("pending" === c14.sessionStatus || !c14.userId) {
                    return q3 ? d13(q3) : "document" === (n3 = f11).headers.get(b9.Headers.SecFetchDest) || "iframe" === n3.headers.get(b9.Headers.SecFetchDest) || (null == (o3 = n3.headers.get(b9.Headers.Accept)) ? void 0 : o3.includes("text/html")) || hl(n3) || hn(n3) ? b15() : e12();
                  }
                  return p3 ? "function" == typeof p3 ? p3(c14.has) ? c14 : t3() : c14.has(p3) ? c14 : t3() : c14;
                };
              }({ request: p2, redirect: (a15) => hh(a15, { redirectUrl: a15 }), notFound: () => function() {
                let a15 = Object.defineProperty(Error(fd), "__NEXT_ERROR_CODE", { value: "E394", enumerable: false, configurable: true });
                throw a15.digest = fd, a15;
              }(), unauthorized: hk, authObject: eE({ authObject: q2, acceptsToken: (null == a14 ? void 0 : a14.token) || (null == b14 ? void 0 : b14.token) || ce.SessionToken }), redirectToSignIn: r2 })(a14, b14)), K2 = (s2 = E2, t2 = H2, u2 = I2, async (a14) => {
                var b14;
                let c14 = s2.toAuth({ treatPendingAsSignedOut: null == a14 ? void 0 : a14.treatPendingAsSignedOut }), d13 = null != (b14 = null == a14 ? void 0 : a14.acceptsToken) ? b14 : ce.SessionToken, e12 = eE({ authObject: c14, acceptsToken: d13 });
                return e12.tokenType === ce.SessionToken && ez(ce.SessionToken, d13) ? Object.assign(e12, { redirectToSignIn: t2, redirectToSignUp: u2 }) : e12;
              });
              K2.protect = J2;
              let L2 = R.next();
              try {
                L2 = await fZ.run(fY, async () => null == f10 ? void 0 : f10(K2, b13, c13)) || L2;
              } catch (a14) {
                L2 = ((a15, b14, c14, d13) => {
                  var e12, f11, g11, h4;
                  if (hf(a15) === hc.UNAUTHORIZED) {
                    let a16 = new R(null, { status: 401 }), b15 = d13.toAuth();
                    if (b15 && b15.tokenType === ce.OAuthToken) {
                      let b16 = bk(d13.publishableKey);
                      return fq(a16, "WWW-Authenticate", `Bearer resource_metadata="https://${null == b16 ? void 0 : b16.frontendApi}/.well-known/oauth-protected-resource"`);
                    }
                    return a16;
                  }
                  if ("object" == typeof (f11 = a15) && null !== f11 && "digest" in f11 && "NEXT_NOT_FOUND" === f11.digest || hf(f11) === hc.NOT_FOUND) return fq(R.rewrite(new URL(`/clerk_${Date.now()}`, c14.url)), b9.Headers.AuthReason, "protect-rewrite");
                  let i4 = !!hj(g11 = a15) && "clerk_digest" in g11 && g11.clerk_digest === hb.REDIRECT_TO_SIGN_IN, j3 = !!hj(h4 = a15) && "clerk_digest" in h4 && h4.clerk_digest === hb.REDIRECT_TO_SIGN_UP;
                  if (i4 || j3) {
                    let c15 = ((a16) => {
                      let { publishableKey: b15, redirectAdapter: c16, signInUrl: d14, signUpUrl: e13, baseUrl: f13, sessionStatus: g12 } = a16, h5 = bk(b15), i5 = h5?.frontendApi, j4 = h5?.instanceType === "development", k3 = bY(i5), l3 = "pending" === g12, m3 = (b16, { returnBackUrl: d15 }) => c16(ca(f13, `${b16}/tasks`, d15, j4 ? a16.devBrowserToken : null));
                      return { redirectToSignUp: ({ returnBackUrl: b16 } = {}) => {
                        e13 || k3 || bA.throwMissingPublishableKeyError();
                        let g13 = `${k3}/sign-up`, h6 = e13 || function(a17) {
                          if (!a17) return;
                          let b17 = new URL(a17, f13);
                          return b17.pathname = `${b17.pathname}/create`, b17.toString();
                        }(d14) || g13;
                        return l3 ? m3(h6, { returnBackUrl: b16 }) : c16(ca(f13, h6, b16, j4 ? a16.devBrowserToken : null));
                      }, redirectToSignIn: ({ returnBackUrl: b16 } = {}) => {
                        d14 || k3 || bA.throwMissingPublishableKeyError();
                        let e14 = `${k3}/sign-in`, g13 = d14 || e14;
                        return l3 ? m3(g13, { returnBackUrl: b16 }) : c16(ca(f13, g13, b16, j4 ? a16.devBrowserToken : null));
                      } };
                    })({ redirectAdapter: g1, baseUrl: b14.clerkUrl, signInUrl: d13.signInUrl, signUpUrl: d13.signUpUrl, publishableKey: d13.publishableKey, sessionStatus: null == (e12 = d13.toAuth()) ? void 0 : e12.sessionStatus }), { returnBackUrl: f12 } = a15;
                    return c15[i4 ? "redirectToSignIn" : "redirectToSignUp"]({ returnBackUrl: f12 });
                  }
                  if (hj(a15)) return g1(a15.redirectUrl);
                  throw a15;
                })(a14, B2, b13, E2);
              }
              if (z2.contentSecurityPolicy) {
                let { headers: b14 } = function(a14, b15) {
                  var c14;
                  let d13 = [], e12 = b15.strict ? function() {
                    let a15 = new Uint8Array(16);
                    return crypto.getRandomValues(a15), btoa(Array.from(a15, (a16) => String.fromCharCode(a16)).join(""));
                  }() : void 0, f11 = function(a15, b16, c15, d14) {
                    let e13 = Object.entries(g6.DEFAULT_DIRECTIVES).reduce((a16, [b17, c16]) => (a16[b17] = new Set(c16), a16), {});
                    if (e13["connect-src"].add(b16), a15 && (e13["script-src"].delete("http:"), e13["script-src"].delete("https:"), e13["script-src"].add("'strict-dynamic'"), d14 && e13["script-src"].add(`'nonce-${d14}'`)), c15) {
                      let a16 = /* @__PURE__ */ new Map();
                      Object.entries(c15).forEach(([b17, c16]) => {
                        let d15 = Array.isArray(c16) ? c16 : [c16];
                        g6.DEFAULT_DIRECTIVES[b17] ? function(a17, b18, c17) {
                          if (c17.includes("'none'") || c17.includes("none")) {
                            a17[b18] = /* @__PURE__ */ new Set(["'none'"]);
                            return;
                          }
                          let d16 = /* @__PURE__ */ new Set();
                          a17[b18].forEach((a18) => {
                            d16.add(g6.formatValue(a18));
                          }), c17.forEach((a18) => {
                            d16.add(g6.formatValue(a18));
                          }), a17[b18] = d16;
                        }(e13, b17, d15) : function(a17, b18, c17) {
                          if (c17.includes("'none'") || c17.includes("none")) return a17.set(b18, /* @__PURE__ */ new Set(["'none'"]));
                          let d16 = /* @__PURE__ */ new Set();
                          c17.forEach((a18) => {
                            let b19 = g6.formatValue(a18);
                            d16.add(b19);
                          }), a17.set(b18, d16);
                        }(a16, b17, d15);
                      }), a16.forEach((a17, b17) => {
                    ...
                    return Object.entries(e13).sort(([a16], [b17]) => a16.localeCompare(b17)).map(([a16, b17]) => {
                      let c16 = Array.from(b17).map((a17) => ({ raw: a17, formatted: g6.formatValue(a17) }));
                      return `${a16} ${c16.map((a17) => a17.formatted).join(" ")}`;
                    }).join("; ");
                  }(null != (c14 = b15.strict) && c14, a14, b15.directives, e12);
                  return b15.reportTo && (f11 += "; report-to csp-endpoint", d13.push([b9.Headers.ReportingEndpoints, `csp-endpoint="${b15.reportTo}"`])), b15.reportOnly ? d13.push([b9.Headers.ContentSecurityPolicyReportOnly, f11]) : d13.push([b9.Headers.ContentSecurityPolicy, f11]), e12 && d13.push([b9.Headers.Nonce, e12]), { headers: d13 };
                }((null != (e11 = null == (d12 = bk(x2)) ? void 0 : d12.frontendApi) ? e11 : "").replace("$", ""), z2.contentSecurityPolicy);
                b14.forEach(([a14, b15]) => {
                  fq(L2, a14, b15);
                }), a13.debug("Clerk generated CSP", () => ({ headers: b14 }));
              }
              if (E2.headers && E2.headers.forEach((b14, c14) => {
                c14 === b9.Headers.ContentSecurityPolicy && a13.debug("Content-Security-Policy detected", () => ({ value: b14 })), L2.headers.append(c14, b14);
              }), L2.headers.get(fp.Headers.NextRedirect)) return a13.debug("handlerResult is redirect"), ((a14, b14, c14) => {
                let d13 = b14.headers.get("location");
                if ("true" === b14.headers.get(b9.Headers.ClerkRedirectTo) && d13 && bm(c14.secretKey) && a14.clerkUrl.isCrossOrigin(d13)) {
                  let c15 = a14.cookies.get(fr) || "", e12 = function(a15, b15) {
                    let c16 = new URL(a15), d14 = c16.searchParams.get(fr);
                    c16.searchParams.delete(fr);
                    let e13 = d14 || b15;
                    return e13 && c16.searchParams.set(fr, e13), c16;
                  }(new URL(d13), c15);
                  return R.redirect(e12.href, b14);
                }
                return b14;
              })(B2, L2, z2);
              z2.debug && g0(L2, B2, { [b9.Headers.EnableDebug]: "true" });
              let M2 = y2 === (null == w2 ? void 0 : w2.secretKey) ? { publishableKey: null == w2 ? void 0 : w2.publishableKey, secretKey: null == w2 ? void 0 : w2.secretKey } : {};
              return !function(a14, b14, c14, d13, e12, f11) {
                let g11, { reason: h4, message: i4, status: j3, token: k3 } = c14;
                if (b14 || (b14 = R.next()), b14.headers.get(fp.Headers.NextRedirect)) return;
                "1" === b14.headers.get(fp.Headers.NextResume) && (b14.headers.delete(fp.Headers.NextResume), g11 = new URL(a14.url));
                let l3 = b14.headers.get(fp.Headers.NextRewrite);
                if (l3) {
                  let b15 = new URL(a14.url);
                  if ((g11 = new URL(l3)).origin !== b15.origin) return;
                }
                if (g11) {
                  let c15 = function(a15, b15, c16) {
                    var d14;
                    let e13 = (a16) => !a16 || !Object.values(a16).some((a17) => void 0 !== a17);
                    if (e13(a15) && e13(b15) && !c16) return;
                    if (a15.secretKey && !fB) return void f_.warnOnce("Clerk: Missing `CLERK_ENCRYPTION_KEY`. Required for propagating `secretKey` middleware option. See docs: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys");
                    let f12 = a8() ? fB || (d14 = () => gZ.throwMissingSecretKeyError(), fy || d14(), fy) : fB || fy || g2;
                    return gS.encrypt(JSON.stringify({ ...b15, ...a15, machineAuthObject: null != c16 ? c16 : void 0 }), f12).toString();
                  }(d13, e12, f11);
                  g0(b14, a14, { [b9.Headers.AuthStatus]: j3, [b9.Headers.AuthToken]: k3 || "", [b9.Headers.AuthSignature]: k3 ? gV(k3, (null == d13 ? void 0 : d13.secretKey) || fy || e12.secretKey || "").toString() : "", [b9.Headers.AuthMessage]: i4 || "", [b9.Headers.AuthReason]: h4 || "", [b9.Headers.ClerkUrl]: a14.clerkUrl.toString(), ...c15 ? { [b9.Headers.ClerkRequestData]: c15 } : {} }), b14.headers.set(fp.Headers.NextRewrite, g11.href);
                }
              }(B2, L2, E2, v2, M2, "session_token" === G2.tokenType ? null : ((a14) => {
                let { debug: b14, getToken: c14, has: d13, ...e12 } = a14;
                return e12;
              })(G2)), L2;
            }, (...c13) => {
              let d12, e11, f11 = ("string" == typeof a12 ? (d12 = a12, e11 = fu, () => {
                let a13 = [], b13 = false;
                return { enable: () => {
                  b13 = true;
                }, debug: (...c14) => {
                  b13 && a13.push(c14.map((a14) => "function" == typeof a14 ? a14() : a14));
                }, commit: () => {
                  if (b13) {
                    var c14, f12;
                    for (let b14 of (console.log((c14 = d12, `[clerk debug start: ${c14}]`)), a13)) {
                      let a14 = e11(b14);
                      a14 = a14.split("\n").map((a15) => `  ${a15}`).join("\n"), process.env.VERCEL && (a14 = function(a15, b15) {
                        let c15 = new TextEncoder(), d13 = new TextDecoder("utf-8"), e12 = c15.encode(a15).slice(0, 4096);
                        return d13.decode(e12).replace(/\uFFFD/g, "");
                      }(a14, 4096)), console.log(a14);
                    }
                    console.log((f12 = d12, `[clerk debug end: ${f12}] (@clerk/nextjs=6.36.5,next=${fs.rE},timestamp=${Math.round((/* @__PURE__ */ new Date()).getTime() / 1e3)})`));
                  }
                } };
              }) : a12)(), g11 = b12(f11);
              try {
                let a13 = g11(...c13);
                if ("object" == typeof a13 && "then" in a13 && "function" == typeof a13.then) return a13.then((a14) => (f11.commit(), a14)).catch((a14) => {
                  throw f11.commit(), a14;
                });
                return f11.commit(), a13;
              } catch (a13) {
                throw f11.commit(), a13;
              }
            }), h2 = async (a13, b13) => {
              var d12, e11;
              if ("/clerk-sync-keyless" === a13.nextUrl.pathname) {
                var f11 = a13;
                let b14 = f11.nextUrl.searchParams.get("returnUrl"), c13 = new URL(f11.url);
                return c13.pathname = "", R.redirect(b14 || c13.toString());
              }
              let h3 = "function" == typeof g10 ? await g10(a13) : g10, i3 = await ha((b14) => {
                var c13;
                return null == (c13 = a13.cookies.get(b14)) ? void 0 : c13.value;
              }), j2 = !(h3.publishableKey || fA || (null == i3 ? void 0 : i3.publishableKey)), k2 = null != (e11 = null == (d12 = fW(a13, b9.Headers.Authorization)) ? void 0 : d12.replace("Bearer ", "")) ? e11 : "";
              if (j2 && !ew(k2)) {
                let b14 = R.next();
                return g0(b14, a13, { [b9.Headers.AuthStatus]: "signed-out" }), b14;
              }
              return c12(a13, b13);
            }, i2 = async (a13, b13) => fL ? h2(a13, b13) : c12(a13, b13);
            return d11 && e10 ? i2(d11, e10) : i2;
          });
        })(async (a11, b11) => {
          if (hC(b11)) {
            let b12 = await a11();
            if (!b12.userId) return b12.redirectToSignIn();
          }
          return R.next();
        })(a10, b10);
        if (hC(a10)) {
          if ("/admin/login" === c10) return R.next();
          let b11 = a10.cookies.get("lizard_session")?.value;
          if (b11) {
            if (ho.some((a11) => c10.startsWith(a11))) {
              let d12 = a10.env?.DB;
              if (!await hA(b11, d12)) {
                let b12 = a10.nextUrl.clone();
                return b12.pathname = "/admin/login", b12.searchParams.set("returnTo", c10), b12.searchParams.set("reason", "session_stale"), R.redirect(b12);
              }
            }
            return R.next();
          }
          let d11 = a10.nextUrl.clone();
          return d11.pathname = "/admin/login", R.redirect(d11);
        }
        return R.next();
      }
      async function hE(a10) {
        try {
          let { pathname: b10 } = a10.nextUrl, c10 = a10.env;
          if (c10?.DB) {
            let d10 = await c10.DB.prepare("SELECT destination_path, type FROM redirects WHERE source_path = ?").bind(b10).first();
            if (d10) return R.redirect(new URL(d10.destination_path, a10.url), d10.type || 301);
          }
        } catch (a11) {
        }
        return null;
      }
      let hF = { matcher: ["/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)", "/(api|trpc)(.*)"] };
      c(747);
      let hG = { ...e }, hH = hG.middleware || hG.default, hI = "/src/middleware";
      if ("function" != typeof hH) throw Object.defineProperty(Error(`The Middleware "${hI}" must export a \`middleware\` or a \`default\` function`), "__NEXT_ERROR_CODE", { value: "E120", enumerable: false, configurable: true });
      function hJ(a10) {
        return a4({ ...a10, page: hI, handler: async (...a11) => {
          try {
            return await hH(...a11);
          } catch (e10) {
...
var NextConfig = { "env": { "CLOUDFLARE_API_TOKEN": "", "CLOUDFLARE_ACCOUNT_ID": "", "CF_PROJECT_NAME": "" }, "webpack": null, "eslint": { "ignoreDuringBuilds": true }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "maximumResponseBody": 5e7, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [{ "protocol": "https", "hostname": "placehold.co", "port": "", "pathname": "/**" }], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "C:\\Dev\\Lizardware-Dev\\.tmp\\launcher-build", "experimental": { "useSkewCookie": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "clientParamParsing": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 7, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "cacheComponents": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolSegmentExplorer": true, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "middlewareClientMaxBodySize": 10485760, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "serverExternalPackages": ["@opennextjs/cloudflare"], "turbopack": { "root": "C:\\Dev\\Lizardware-Dev\\.tmp\\launcher-build" } };
var BuildId = "C_J6mZZisngkX3Lzehcp8";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/about", "regex": "^/about(?:/)?$", "routeKeys": {}, "namedRegex": "^/about(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/content", "regex": "^/admin/content(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/content(?:/)?$" }, { "page": "/admin/content/blog", "regex": "^/admin/content/blog(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/content/blog(?:/)?$" }, { "page": "/admin/content/blog/authors", "regex": "^/admin/content/blog/authors(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/content/blog/authors(?:/)?$" }, { "page": "/admin/content/blog/categories", "regex": "^/admin/content/blog/categories(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/content/blog/categories(?:/)?$" }, { "page": "/admin/content/changelogs", "regex": "^/admin/content/changelogs(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/content/changelogs(?:/)?$" }, { "page": "/admin/content/changelogs/new", "regex": "^/admin/content/changelogs/new(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/content/changelogs/new(?:/)?$" }, { "page": "/admin/content/media", "regex": "^/admin/content/media(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/content/media(?:/)?$" }, { "page": "/admin/content/pages", "regex": "^/admin/content/pages(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/content/pages(?:/)?$" }, { "page": "/admin/design", "regex": "^/admin/design(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/design(?:/)?$" }, { "page": "/admin/design/features", "regex": "^/admin/design/features(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/design/features(?:/)?$" }, { "page": "/admin/design/identity", "regex": "^/admin/design/identity(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/design/identity(?:/)?$" }, { "page": "/admin/design/nav", "regex": "^/admin/design/nav(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/design/nav(?:/)?$" }, { "page": "/admin/design/theme", "regex": "^/admin/design/theme(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/design/theme(?:/)?$" }, { "page": "/admin/diagnostics", "regex": "^/admin/diagnostics(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/diagnostics(?:/)?$" }, { "page": "/admin/growth", "regex": "^/admin/growth(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth(?:/)?$" }, { "page": "/admin/growth/analytics", "regex": "^/admin/growth/analytics(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth/analytics(?:/)?$" }, { "page": "/admin/growth/monetization", "regex": "^/admin/growth/monetization(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth/monetization(?:/)?$" }, { "page": "/admin/growth/newsletter", "regex": "^/admin/growth/newsletter(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth/newsletter(?:/)?$" }, { "page": "/admin/growth/seo", "regex": "^/admin/growth/seo(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth/seo(?:/)?$" }, { "page": "/admin/growth/seo/defaults", "regex": "^/admin/growth/seo/defaults(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth/seo/defaults(?:/)?$" }, { "page": "/admin/growth/seo/meta", "regex": "^/admin/growth/seo/meta(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth/seo/meta(?:/)?$" }, { "page": "/admin/growth/seo/redirects", "regex": "^/admin/growth/seo/redirects(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth/seo/redirects(?:/)?$" }, { "page": "/admin/growth/seo/robots", "regex": "^/admin/growth/seo/robots(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth/seo/robots(?:/)?$" }, { "page": "/admin/growth/seo/wizard", "regex": "^/admin/growth/seo/wizard(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth/seo/wizard(?:/)?$" }, { "page": "/admin/growth/social", "regex": "^/admin/growth/social(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/growth/social(?:/)?$" }, { "page": "/admin/login", "regex": "^/admin/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/login(?:/)?$" }, { "page": "/admin/profile", "regex": "^/admin/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/profile(?:/)?$" }, { "page": "/admin/settings", "regex": "^/admin/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/settings(?:/)?$" }, { "page": "/admin/system", "regex": "^/admin/system(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/system(?:/)?$" }, { "page": "/admin/system/advanced", "regex": "^/admin/system/advanced(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/system/advanced(?:/)?$" }, { "page": "/admin/system/config", "regex": "^/admin/system/config(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/system/config(?:/)?$" }, { "page": "/admin/system/logs", "regex": "^/admin/system/logs(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/system/logs(?:/)?$" }, { "page": "/admin/system/security", "regex": "^/admin/system/security(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/system/security(?:/)?$" }, { "page": "/admin/system/updates", "regex": "^/admin/system/updates(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/system/updates(?:/)?$" }, { "page": "/blog", "regex": "^/blog(?:/)?$", "routeKeys": {}, "namedRegex": "^/blog(?:/)?$" }, { "page": "/blog/authors", "regex": "^/blog/authors(?:/)?$", "routeKeys": {}, "namedRegex": "^/blog/authors(?:/)?$" }, { "page": "/blog/tags", "regex": "^/blog/tags(?:/)?$", "routeKeys": {}, "namedRegex": "^/blog/tags(?:/)?$" }, { "page": "/changelog", "regex": "^/changelog(?:/)?$", "routeKeys": {}, "namedRegex": "^/changelog(?:/)?$" }, { "page": "/changelog/latest", "regex": "^/changelog/latest(?:/)?$", "routeKeys": {}, "namedRegex": "^/changelog/latest(?:/)?$" }, { "page": "/contact", "regex": "^/contact(?:/)?$", "routeKeys": {}, "namedRegex": "^/contact(?:/)?$" }, { "page": "/icon.png", "regex": "^/icon\\.png(?:/)?$", "routeKeys": {}, "namedRegex": "^/icon\\.png(?:/)?$" }, { "page": "/platform", "regex": "^/platform(?:/)?$", "routeKeys": {}, "namedRegex": "^/platform(?:/)?$" }, { "page": "/privacy", "regex": "^/privacy(?:/)?$", "routeKeys": {}, "namedRegex": "^/privacy(?:/)?$" }, { "page": "/roadmap", "regex": "^/roadmap(?:/)?$", "routeKeys": {}, "namedRegex": "^/roadmap(?:/)?$" }, { "page": "/robots.txt", "regex": "^/robots\\.txt(?:/)?$", "routeKeys": {}, "namedRegex": "^/robots\\.txt(?:/)?$" }, { "page": "/setup", "regex": "^/setup(?:/)?$", "routeKeys": {}, "namedRegex": "^/setup(?:/)?$" }, { "page": "/sitemap.xml", "regex": "^/sitemap\\.xml(?:/)?$", "routeKeys": {}, "namedRegex": "^/sitemap\\.xml(?:/)?$" }, { "page": "/support", "regex": "^/support(?:/)?$", "routeKeys": {}, "namedRegex": "^/support(?:/)?$" }, { "page": "/terms", "regex": "^/terms(?:/)?$", "routeKeys": {}, "namedRegex": "^/terms(?:/)?$" }, { "page": "/testing/originals/feature-content-management", "regex": "^/testing/originals/feature\\-content\\-management(?:/)?$", "routeKeys": {}, "namedRegex": "^/testing/originals/feature\\-content\\-management(?:/)?$" }, { "page": "/testing/originals/home", "regex": "^/testing/originals/home(?:/)?$", "routeKeys": {}, "namedRegex": "^/testing/originals/home(?:/)?$" }], "dynamic": [{ "page": "/admin/content/changelogs/[version]", "regex": "^/admin/content/changelogs/([^/]+?)(?:/)?$", "routeKeys": { "nxtPversion": "nxtPversion" }, "namedRegex": "^/admin/content/changelogs/(?<nxtPversion>[^/]+?)(?:/)?$" }, { "page": "/admin/editor/[type]/[...slug]", "regex": "^/admin/editor/([^/]+?)/(.+?)(?:/)?$", "routeKeys": { "nxtPtype": "nxtPtype", "nxtPslug": "nxtPslug" }, "namedRegex": "^/admin/editor/(?<nxtPtype>[^/]+?)/(?<nxtPslug>.+?)(?:/)?$" }, { "page": "/api/admin/blog/[slug]", "regex": "^/api/admin/blog/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/admin/blog/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/admin/changelogs/[version]", "regex": "^/api/admin/changelogs/([^/]+?)(?:/)?$", "routeKeys": { "nxtPversion": "nxtPversion" }, "namedRegex": "^/api/admin/changelogs/(?<nxtPversion>[^/]+?)(?:/)?$" }, { "page": "/api/admin/internal/[slug]", "regex": "^/api/admin/internal/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/admin/internal/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/admin/pages/[...slug]", "regex": "^/api/admin/pages/(.+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/admin/pages/(?<nxtPslug>.+?)(?:/)?$" }, { "page": "/api/admin/seo/redirects/[id]", "regex": "^/api/admin/seo/redirects/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/seo/redirects/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/admin/settings/[key]", "regex": "^/api/admin/settings/([^/]+?)(?:/)?$", "routeKeys": { "nxtPkey": "nxtPkey" }, "namedRegex": "^/api/admin/settings/(?<nxtPkey>[^/]+?)(?:/)?$" }, { "page": "/api/admin/testing/[slug]", "regex": "^/api/admin/testing/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/admin/testing/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/blog/[slug]", "regex": "^/api/blog/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/blog/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/api/media/blob/[id]", "regex": "^/api/media/blob/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/media/blob/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/media/file/[key]", "regex": "^/api/media/file/([^/]+?)(?:/)?$", "routeKeys": { "nxtPkey": "nxtPkey" }, "namedRegex": "^/api/media/file/(?<nxtPkey>[^/]+?)(?:/)?$" }, { "page": "/api/posts/[slug]", "regex": "^/api/posts/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/api/posts/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/blog/author/[authorId]", "regex": "^/blog/author/([^/]+?)(?:/)?$", "routeKeys": { "nxtPauthorId": "nxtPauthorId" }, "namedRegex": "^/blog/author/(?<nxtPauthorId>[^/]+?)(?:/)?$" }, { "page": "/blog/tag/[tagSlug]", "regex": "^/blog/tag/([^/]+?)(?:/)?$", "routeKeys": { "nxtPtagSlug": "nxtPtagSlug" }, "namedRegex": "^/blog/tag/(?<nxtPtagSlug>[^/]+?)(?:/)?$" }, { "page": "/blog/[slug]", "regex": "^/blog/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/blog/(?<nxtPslug>[^/]+?)(?:/)?$" }, { "page": "/changelog/[version]", "regex": "^/changelog/([^/]+?)(?:/)?$", "routeKeys": { "nxtPversion": "nxtPversion" }, "namedRegex": "^/changelog/(?<nxtPversion>[^/]+?)(?:/)?$" }, { "page": "/sign-in/[[...sign-in]]", "regex": "^/sign\\-in(?:/(.+?))?(?:/)?$", "routeKeys": { "nxtPsignin": "nxtPsign-in" }, "namedRegex": "^/sign\\-in(?:/(?<nxtPsignin>.+?))?(?:/)?$" }, { "page": "/[slug]", "regex": "^/([^/]+?)(?:/)?$", "routeKeys": { "nxtPslug": "nxtPslug" }, "namedRegex": "^/(?<nxtPslug>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/icon.png": { "initialHeaders": { "cache-control": "public, immutable, no-transform, max-age=31536000", "content-type": "image/png", "x-next-cache-tags": "_N_T_/layout,_N_T_/icon.png/layout,_N_T_/icon.png/route,_N_T_/icon.png" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/icon.png", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "cd63cec35c13816c7c0e9f9e190eecde", "previewModeSigningKey": "16d5960386ab944ff109e272460060195ebadcfe5d3a18502324cc0beccbac34", "previewModeEncryptionKey": "d702ded3b36f066995aa1986a5f09160b2019f2766d05d7d733e53242491785a" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(api|trpc))(.*)(\\.json)?[\\/#\\?]?$", "originalSource": "/(api|trpc)(.*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "C_J6mZZisngkX3Lzehcp8", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "h0loBbv+yuZ7TEUnpg0/sonwy0CmctkpfwxBQKeAG9E=", "__NEXT_PREVIEW_MODE_ID": "cd63cec35c13816c7c0e9f9e190eecde", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "16d5960386ab944ff109e272460060195ebadcfe5d3a18502324cc0beccbac34", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "d702ded3b36f066995aa1986a5f09160b2019f2766d05d7d733e53242491785a" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/admin/blog/authors/route": "/api/admin/blog/authors", "/api/admin/blog/[slug]/route": "/api/admin/blog/[slug]", "/api/admin/blog/commit/route": "/api/admin/blog/commit", "/api/admin/blog/categories/route": "/api/admin/blog/categories", "/api/admin/blog/settings/route": "/api/admin/blog/settings", "/api/admin/check-d1/route": "/api/admin/check-d1", "/api/admin/check-db-init/route": "/api/admin/check-db-init", "/api/admin/check-kv/route": "/api/admin/check-kv", "/api/admin/changelogs/settings/route": "/api/admin/changelogs/settings", "/api/admin/dev-status/route": "/api/admin/dev-status", "/api/admin/diagnostics/migration-check/route": "/api/admin/diagnostics/migration-check", "/api/admin/check-r2/route": "/api/admin/check-r2", "/api/admin/diagnostic/env/route": "/api/admin/diagnostic/env", "/api/admin/features/route": "/api/admin/features", "/api/admin/hub-settings/route": "/api/admin/hub-settings", "/api/admin/growth/newsletter/subscribers/route": "/api/admin/growth/newsletter/subscribers", "/api/admin/internal/[slug]/route": "/api/admin/internal/[slug]", "/api/admin/internal/route": "/api/admin/internal", "/api/admin/init-database/route": "/api/admin/init-database", "/api/admin/media/bulk-delete/route": "/api/admin/media/bulk-delete", "/api/admin/media/delete/route": "/api/admin/media/delete", "/api/admin/media/list/route": "/api/admin/media/list", "/api/admin/media/update/route": "/api/admin/media/update", "/api/admin/media/storage-preference/route": "/api/admin/media/storage-preference", "/api/admin/media/upload/route": "/api/admin/media/upload", "/api/admin/monetization/route": "/api/admin/monetization", "/api/admin/nav/route": "/api/admin/nav", "/api/admin/navigation/item/route": "/api/admin/navigation/item", "/api/admin/navigation/reorder/route": "/api/admin/navigation/reorder", "/api/admin/navigation/route": "/api/admin/navigation", "/api/admin/pages/[...slug]/route": "/api/admin/pages/[...slug]", "/api/admin/pages/route": "/api/admin/pages", "/api/admin/routes/route": "/api/admin/routes", "/api/admin/roadmap/settings/route": "/api/admin/roadmap/settings", "/api/admin/seo/redirects/route": "/api/admin/seo/redirects", "/api/admin/security/settings/route": "/api/admin/security/settings", "/api/admin/seo/redirects/[id]/route": "/api/admin/seo/redirects/[id]", "/api/admin/seo/wizard/route": "/api/admin/seo/wizard", "/api/admin/settings/[key]/route": "/api/admin/settings/[key]", "/api/admin/setup-status/route": "/api/admin/setup-status", "/api/admin/setup/auto-provision/route": "/api/admin/setup/auto-provision", "/api/admin/setup/check-system-token/route": "/api/admin/setup/check-system-token", "/api/admin/setup/provision-r2/route": "/api/admin/setup/provision-r2", "/api/admin/setup/create-user/route": "/api/admin/setup/create-user", "/api/admin/setup/check-users/route": "/api/admin/setup/check-users", "/api/admin/setup/verify-credentials/route": "/api/admin/setup/verify-credentials", "/api/admin/sync-profile/route": "/api/admin/sync-profile", "/api/admin/system/registry/route": "/api/admin/system/registry", "/api/admin/testing/route": "/api/admin/testing", "/api/admin/testing/[slug]/route": "/api/admin/testing/[slug]", "/api/admin/updates/check/route": "/api/admin/updates/check", "/api/auth/login/route": "/api/auth/login", "/api/auth/logout/route": "/api/auth/logout", "/api/auth/me/route": "/api/auth/me", "/api/auth/profile/route": "/api/auth/profile", "/api/auth/register/route": "/api/auth/register", "/api/auth/session-age/route": "/api/auth/session-age", "/api/auth/status/route": "/api/auth/status", "/api/blog/route": "/api/blog", "/api/config/theme/route": "/api/config/theme", "/api/blog/[slug]/route": "/api/blog/[slug]", "/api/debug-d1/route": "/api/debug-d1", "/api/media/blob/[id]/route": "/api/media/blob/[id]", "/api/nano/route": "/api/nano", "/api/posts/[slug]/route": "/api/posts/[slug]", "/api/posts/route": "/api/posts", "/api/webhooks/clerk/route": "/api/webhooks/clerk", "/api/media/file/[key]/route": "/api/media/file/[key]", "/icon.png/route": "/icon.png", "/api/admin/activity/route": "/api/admin/activity", "/api/admin/blog/bulk/route": "/api/admin/blog/bulk", "/api/admin/blog/route": "/api/admin/blog", "/api/admin/changelogs/recent/route": "/api/admin/changelogs/recent", "/api/admin/changelogs/[version]/route": "/api/admin/changelogs/[version]", "/api/admin/debug/env/route": "/api/admin/debug/env", "/api/admin/changelogs/route": "/api/admin/changelogs", "/api/admin/diagnostics/wrangler-config/route": "/api/admin/diagnostics/wrangler-config", "/api/admin/internal/search/route": "/api/admin/internal/search", "/api/admin/env/route": "/api/admin/env", "/api/admin/media/bulk-update/route": "/api/admin/media/bulk-update", "/api/admin/media/route": "/api/admin/media", "/api/admin/media/usage-stats/route": "/api/admin/media/usage-stats", "/api/admin/migrations/migrate-features/route": "/api/admin/migrations/migrate-features", "/api/admin/nav/suggestions/route": "/api/admin/nav/suggestions", "/api/admin/pages/bulk/route": "/api/admin/pages/bulk", "/api/admin/media/usage/route": "/api/admin/media/usage", "/api/admin/recent-docs/route": "/api/admin/recent-docs", "/api/admin/pages/reorder/route": "/api/admin/pages/reorder", "/api/admin/search/route": "/api/admin/search", "/api/admin/seo/robots/route": "/api/admin/seo/robots", "/api/admin/setup/lookup-account/route": "/api/admin/setup/lookup-account", "/api/config/site/route": "/api/config/site", "/api/admin/setup-lock/route": "/api/admin/setup-lock", "/robots.txt/route": "/robots.txt", "/api/diag/route": "/api/diag", "/sitemap.xml/route": "/sitemap.xml", "/(auth)/admin/login/page": "/admin/login", "/(public)/changelog/latest/page": "/changelog/latest", "/(pages)/testing/originals/feature-content-management/page": "/testing/originals/feature-content-management", "/(public)/changelog/[version]/page": "/changelog/[version]", "/(auth)/sign-in/[[...sign-in]]/page": "/sign-in/[[...sign-in]]", "/(pages)/about/page": "/about", "/(pages)/[slug]/page": "/[slug]", "/(pages)/contact/page": "/contact", "/(pages)/privacy/page": "/privacy", "/(pages)/support/page": "/support", "/(pages)/terms/page": "/terms", "/(pages)/platform/page": "/platform", "/(pages)/testing/originals/home/page": "/testing/originals/home", "/(public)/roadmap/page": "/roadmap", "/(public)/changelog/page": "/changelog", "/page": "/", "/(pages)/blog/author/[authorId]/page": "/blog/author/[authorId]", "/(pages)/blog/page": "/blog", "/(pages)/blog/tag/[tagSlug]/page": "/blog/tag/[tagSlug]", "/(pages)/blog/[slug]/page": "/blog/[slug]", "/(pages)/blog/tags/page": "/blog/tags", "/(pages)/blog/authors/page": "/blog/authors", "/(setup)/setup/page": "/setup", "/(admin)/admin/content/blog/categories/page": "/admin/content/blog/categories", "/(admin)/admin/content/blog/authors/page": "/admin/content/blog/authors", "/(admin)/admin/content/blog/page": "/admin/content/blog", "/(admin)/admin/content/changelogs/[version]/page": "/admin/content/changelogs/[version]", "/(admin)/admin/content/page": "/admin/content", "/(admin)/admin/content/changelogs/page": "/admin/content/changelogs", "/(admin)/admin/content/changelogs/new/page": "/admin/content/changelogs/new", "/(admin)/admin/content/media/page": "/admin/content/media", "/(admin)/admin/content/pages/page": "/admin/content/pages", "/(admin)/admin/design/features/page": "/admin/design/features", "/(admin)/admin/design/page": "/admin/design", "/(admin)/admin/design/nav/page": "/admin/design/nav", "/(admin)/admin/diagnostics/page": "/admin/diagnostics", "/(admin)/admin/design/identity/page": "/admin/design/identity", "/(admin)/admin/growth/analytics/page": "/admin/growth/analytics", "/(admin)/admin/growth/monetization/page": "/admin/growth/monetization", "/(admin)/admin/growth/page": "/admin/growth", "/(admin)/admin/growth/newsletter/page": "/admin/growth/newsletter", "/(admin)/admin/growth/seo/defaults/page": "/admin/growth/seo/defaults", "/(admin)/admin/growth/seo/meta/page": "/admin/growth/seo/meta", "/(admin)/admin/growth/seo/robots/page": "/admin/growth/seo/robots", "/(admin)/admin/growth/seo/page": "/admin/growth/seo", "/(admin)/admin/growth/seo/redirects/page": "/admin/growth/seo/redirects", "/(admin)/admin/settings/page": "/admin/settings", "/(admin)/admin/growth/social/page": "/admin/growth/social", "/(admin)/admin/page": "/admin", "/(admin)/admin/system/logs/page": "/admin/system/logs", "/(admin)/admin/profile/page": "/admin/profile", "/(admin)/admin/growth/seo/wizard/page": "/admin/growth/seo/wizard", "/(admin)/admin/system/config/page": "/admin/system/config", "/(admin)/admin/system/page": "/admin/system", "/(admin)/admin/system/security/page": "/admin/system/security", "/(admin)/admin/system/updates/page": "/admin/system/updates", "/(admin)/admin/editor/[type]/[...slug]/page": "/admin/editor/[type]/[...slug]", "/(admin)/admin/design/theme/page": "/admin/design/theme", "/(admin)/admin/system/advanced/page": "/admin/system/advanced" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/admin/changelogs/recent": {}, "/api/admin/diagnostics/wrangler-config": {}, "/api/admin/env": {}, "/api/admin/media": {}, "/api/admin/nav/suggestions": {}, "/api/admin/recent-docs": {}, "/api/admin/search": {}, "/api/admin/setup/lookup-account": {} } };
